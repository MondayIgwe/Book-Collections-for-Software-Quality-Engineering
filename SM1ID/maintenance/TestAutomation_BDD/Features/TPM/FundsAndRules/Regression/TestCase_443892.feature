...
Scenario: WEB_TPM_SP_ANOM_GL_CHECKSETVALIDATION_NOCONSTR_001
	...
	And the user checks the 'Grid CheckBox' with value '#FundsRulesCode1#(1)-<DESCRIPTION>'
	And the user checks the 'Grid CheckBox' with value '#FundsRulesCode2#(1)-<DESCRIPTION>'
