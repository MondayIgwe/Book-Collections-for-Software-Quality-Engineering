...
Scenario: FRM_REFDOC_EXPORTAMCHART_001
    ...
    When the user creates a Reference doc 'Today' 'Today' 'Test226986' 'voice1' 'Today' 'Test226986'
    ...
    Then the user validates that the 'Revenue x product line.png' is downloaded successfully
    ...
    Then the user validates that the 'Revenue x product line.jpg' is downloaded successfully
    ...
    Then the user validates that the 'Revenue x product line.svg' is downloaded successfully
    ...
    Then the user validates that the 'Revenue x product line.pdf' is downloaded successfully