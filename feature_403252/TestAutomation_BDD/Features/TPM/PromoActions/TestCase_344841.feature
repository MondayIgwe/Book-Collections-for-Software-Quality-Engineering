...
@BDD_344841 @PROMO_Nightly @PromoActions
Scenario: TPM_SP_W_SMOKE_R80V1_0013 - Mass Copy
	...
	And the user populates the cockpit '<PROMODESC1>' '<SELLINSTART>' '<SELLINEND>' '<SELLOUTSTARTDATE>' '<SELLOUTENDDATE>' '<MECH>'
	...
	And the user adds a product 'Product' '<PRODCODE>'
	...
	And the user adds a product 'Display' '<PRODDESC>'
	...
	#second promo
	And the user creates a Promo '<CUSTLEV>' '<CUST2>'
	And the user populates the cockpit '<PROMODESC2>' '<SELLINSTART>' '<SELLINEND>' '<SELLOUTSTARTDATE>' '<SELLOUTENDDATE>' '<MECH>'
	And the user clicks on 'Side Panel Tab' with value 'Cockpit'
	And the user retrieves text from element 'Input By Label Name' with value 'Action Id' and saves it as 'ActionId2'
	And the user adds a product 'Product' '<PRODCODE2>'
	...
	And the user clicks on the 'Close Tab'
	#third promo
	And the user creates a Promo '<CUSTLEV>' '<CUST3>'
	And the user populates the cockpit '<PROMODESC3>' '<SELLINSTART>' '<SELLINEND>' '<SELLOUTSTARTDATE>' '<SELLOUTENDDATE>' '<MECH>'
	And the user clicks on 'Side Panel Tab' with value 'Cockpit'
	...
	And the user clicks on the 'Close Tab'
	#fourth promo
	And the user creates a Promo '<CUSTLEV>' '<CUST4>'
	And the user populates the cockpit '<PROMODESC4>' '<SELLINSTART>' '<SELLINEND>' '<SELLOUTSTARTDATE>' '<SELLOUTENDDATE>' '<MECH>'
	And the user clicks on 'Side Panel Tab' with value 'Cockpit'
	...
	And the user clicks on 'Grid CheckBox' with value 'ActionId1'
	...
	Then the user validates that the 'Generic Drop Down Trigger' with value 'Units to shift' is present
	#When the user clicks on 'Generic Drop Down Trigger' with value 'Units to shift'
	When the user clicks on 'Generic Drop Down Trigger' with value 'Units to shift' until 'List' with value '<unitsShift_1>' is present
	...
	And the user validates that 'Input By Label Name' with value 'Period to shift' has text '<periodsShift>'
	When the user clicks on 'Input By Label Name' with value 'Period to shift'
	#Keep the day of the week = FALSE @keepDay
	Then the user validates that the checkbox container 'sm1-tr contianer' with value '[GUIPROMOACTIONMASSCOPY.KEEPDAY]' is set to the state: '<keepDay>'
	...
	And the user clicks on 'Grid CheckBox' with value 'ActionId3'
	And the user clicks on 'Grid CheckBox' with value 'ActionId4'
	And the user enters '3' in field 'Input By Label Name' with value 'Period to shift'
	#7 Execute "Mass Copy"
	And the user clicks on 'Button' with value 'Execute Copy'
	...
	And the user clicks on the 'Close Tab'
	And the user clicks on the 'Refresh Button'
	And the user filters the column by column name 'Action code', 'Like', 'GeneratedActionId1'
	Then the user validates that column 'Sell-in start' has '<COPY_SELLINSTART>' with row text 'GeneratedActionId1'
	When the user filters the column by column name 'Action code', 'Like', 'GeneratedActionId2'
	Then the user validates that column 'Sell-in start' has '<COPY_SELLINSTART>' with row text 'GeneratedActionId2'
	When the user filters the column by column name 'Action code', 'Like', 'GeneratedActionId3'
	Then the user validates that column 'Sell-in start' has '<COPY_SELLINSTART>' with row text 'GeneratedActionId3'
	When the user filters the column by column name 'Action code', 'Like', 'GeneratedActionId4'
