...
Scenario: WEB_TPM_IBP_SPLIT_ROL_MEAS_001
	...
	When the user changes the Combo Label: '<Filter2>' to Combo Label: '<Category>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<Filter3>' to Combo Label: '<Measure1>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<Filter3>' to Combo Label: '<Measure3>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<Filter1>' to Combo Label: '<Customer>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<Filter3>' to Combo Label: '<Measure2>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
