...
Scenario: FRM_REFDOC_WORKFLOW_002
    ...
    And the user filters the column by column name 'Name', 'Like', '<Entity>'
    ...
    Then the user validates that the grid has no text with value 'Anomaly Test2' on column 'Description'
    When the user clicks on the 'Workflow Current Status Trigger'
    Then the user validates that the 'Popup' with value 'Change Status' is displayed
    ...
    And the user clicks on 'Popup Button' with value 'OK'
    Then the user validates that 'Toast Message Field' text contains 'Reference document document successfully saved'
    And 'Workflow Current Status Textfield' is populated with 'Workflow state 2'
    ...
    When the user clicks on the 'Summary Current Status Trigger'
    Then the user validates that the 'Popup' with value 'Change Status' is displayed
    ...
    # Step 23
    And the user clicks on 'Side Panel Tab' with value 'Workflow'
    When the user clicks on the 'ReEvaluate Anomalies Button'
    Then the user validates that column 'Description' has 'Document description is missing' with row text 'Document description is missing'
