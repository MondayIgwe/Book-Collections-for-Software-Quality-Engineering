...
Scenario: TC875813 WEB_SA_CLAIM_CLAIM DOCUMENT_AGGREGATED MATCHINGS PAGE_001
    ...
    When the user creates a New Claim with Document Type: '<DocumentType>' Document Number: '<DocumentNumber>' Level: '<Level>' Customer: '<Customer>' Amount: '<Amount>'
	...
	When the user clicks on 'Button' with value 'Match'
    Then the user validates the 'Promo ID Mechanics Option' is disabled
