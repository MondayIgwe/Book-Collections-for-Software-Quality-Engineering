...
{
    public class BudgetGroupStepHelpers : CommonStepHelpers
    {
        ...
        /// <summary>
        /// Populates thes Budget Group General Info Tab's required fielss
        /// </summary>
        /// <param name="description">The Budget Group Description</param>
        /// <param name="measureUnit">The Budget Group Measure Unit</param>
        /// <param name="budgetMeasures">The Budget Group Measures</param>
