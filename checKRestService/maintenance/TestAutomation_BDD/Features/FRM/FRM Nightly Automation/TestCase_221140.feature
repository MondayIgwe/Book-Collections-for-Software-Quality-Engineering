...
Scenario:  FRM_REFDOC_SECTION_001
    ...
    Then the user validates that the 'Section Collapse Icon' with value 'Available Fields' is not displayed
    And the user validates that the 'Section Collapse Icon' with value 'New Dropdown section' is not displayed
    ...
    Then the user validates that the 'Section Collapse Icon' with value 'Available Fields' is displayed
    And the user validates that the 'Section Collapse Icon' with value 'New Dropdown section' is displayed
