...
namespace Kantar_BDD.Pages.Popups
{
    ...
    public class SavePopup
    {
        ...
        public static readonly AbstractedBy NoButton = AbstractedBy.Xpath("No Button", "//div[@role = 'alertdialog'][@aria-hidden = 'false']//div[@class='x-box-inner']//child::a[@sm1-id='messageboxbuttonno']//span[text()='No']");
