...
namespace Kantar_BDD.Pages.Grids
{
    ...
    public class CustomerMasterGrid
    {
        ...
        public static readonly AbstractedBy RowsLeft = AbstractedBy.Xpath("Customer Master pop up Rows",
            "//div[text() = 'Customer Master']//ancestor::div[@role='dialog']//div[contains(@class, 'x-grid-scrollbar-clipper-locked ')]//table");
        public static readonly AbstractedBy RowsRight = AbstractedBy.Xpath("Customer Master pop up Rows",
