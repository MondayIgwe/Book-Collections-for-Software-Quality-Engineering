...
Scenario: WEB_SFA_SE_VISIT_007_VISIT_INFO_TAB_FOR_CUSTOMERS_AND_POS_BDD
	...
	Then the user validates that the user is on the 'Visits' page
	
	When the user filters the column by column name 'Id Visit', Filter Type 'Like', Value '<FilterValue2>'
	And the user opens the grid item in row '1'
	And the user clicks on 'Side Panel Tab' with value 'Visit info'
