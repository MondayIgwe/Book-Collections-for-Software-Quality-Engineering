...
Scenario: FRM_REFDOC_DATEPICKER_004
	...
	And the user enters '<Numeric>' in the 'Available Fields Date Picker Textbox'
	...
	Then the user validates the 'Available Fields Date Picker Textbox' has no text
	
	# Step 2 - write this @Text -> lose focus 
	When the user enters '<Text>' in the 'Available Fields Date Picker Textbox'
	And the user moves the focus to the 'Save Button'
	...
	When the user enters '<InvalidDate>' in the 'Available Fields Date Picker Textbox'
	And the user moves the focus to the 'Save Button'
	...
	When the user enters '<WrongFormatDate>' in the 'Available Fields Date Picker Textbox'
	And the user moves the focus to the 'Save Button'
	...
	When the user enters '<WrongDate>' in the 'Available Fields Date Picker Textbox'
	And the user moves the focus to the 'Save Button'
