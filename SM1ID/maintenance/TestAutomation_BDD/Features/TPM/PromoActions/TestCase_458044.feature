...
@BDD_458044 @PROMO_Nightly @PromoActions @PromoActionsNightly
Scenario: WEB_TPM_SP_PROMOPLANDOCUMENT_DRAGDROP_PROMO_BORDERS_001
	...
	And the user populates the cockpit with description: '<DESCR_PROMO>' sellInStart: '<SELLINSTART>' sellInEnd: '<SELLINEND>' sellOutStart: '<SELLOUTSTARTDATE>' sellOutEnd: '<SELLOUTENDDATE>' mechanics: '<MECHANICS>'
	...
	And the user adds a product with productLevel: 'Product' productCodes: '<PRODS>'
	And the user adds a product with productLevel: 'Product' productCodes: '<PRODS2>'
	...
	When the user creates a Promo with customerHLevel: '<CUSTLEV>' customerCode: '<CUST>'
	And the user populates the cockpit with description: '<DESCR_PROMO2>' sellInStart: '<SELLINSTART2>' sellInEnd: '<SELLINEND2>' sellOutStart: '<SELLOUTSTARTDATE>' sellOutEnd: '<SELLOUTENDDATE>' mechanics: '<MECHANICS>'
	...
	And the user filters the column by column name 'Year of Reference', Filter Type 'Equal', Value '<REFYEAR2>'
	...
	And the user populates the cockpit with description: '<DESCR_PROMO3>' sellInStart: '<SELLINSTART2>' sellInEnd: '<SELLINEND2>' sellOutStart: '<SELLOUTSTARTDATE>' sellOutEnd: '<SELLOUTENDDATE>' mechanics: '<MECHANICS>'
	...
	When the user creates a Promo with customerHLevel: '<PPHOLDERLEV>' customerCode: '<PPHOLDER>'
	And the user populates the cockpit with description: '<DESCR_PROMO4>' sellInStart: '<SELLINSTART2>' sellInEnd: '<SELLINEND2>' sellOutStart: '<SELLOUTSTARTDATE>' sellOutEnd: '<SELLOUTENDDATE>' mechanics: '<MECHANICS>'
	...
	When the user creates a Promo with customerHLevel: '<PPHOLDERLEV2>' customerCode: '<PPHOLDER2>'
	And the user populates the cockpit with description: '<DESCR_PROMO5>' sellInStart: '<SELLINSTART2>' sellInEnd: '<SELLINEND2>' sellOutStart: '<SELLOUTSTARTDATE>' sellOutEnd: '<SELLOUTENDDATE>' mechanics: '<MECHANICS>'
	And the user clicks on side panel 'Cockpit'
	And the user retrieves text from element 'Input By Label Name' with value 'Action Id' and saves it as 'ActionId1'
	And the user adds a product with productLevel: 'Product' productCodes: '<PRODS>'
	And the user adds a product with productLevel: 'Product' productCodes: '<PRODS2>'
	...
	And the user drags promo promoDescription: '<DESCR_PROMO3>' to year '2020' and quarter 'Q3'
	...
	When the user drags promo promoDescription: '<DESCR_PROMO4>' to year '2020' and quarter 'Q3' until element 'Text' with value 'Save changes?' is present
	...
	And the user drags promo promoDescription: '<DESCR_PROMO5>' to year '2020' and quarter 'Q3' until element 'Text' with value 'Save changes?' is present
	...
	When the user drags promo promoDescription: '<DESCR_PROMO5>' to year '2020' and quarter 'Q3' until element 'Text' with value 'Save changes?' is present
	Then the user validates that the 'Text' with value 'Save changes?' is present
