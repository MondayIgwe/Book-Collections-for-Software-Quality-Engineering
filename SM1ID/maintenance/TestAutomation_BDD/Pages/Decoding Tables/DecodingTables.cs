...
namespace Kantar_BDD.Pages.Decoding_Tables
{
    ...
    public class DecodingTables
    {
        ...
        public static readonly AbstractedBy DescriptionField = AbstractedBy.Xpath("Decoding Tables Description Field", "//div[@sm1-id='txtDesTab']//div[contains(@id,'inputEl')]");
