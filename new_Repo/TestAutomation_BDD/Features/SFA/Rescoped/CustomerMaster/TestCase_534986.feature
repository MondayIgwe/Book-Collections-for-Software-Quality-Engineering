...
Scenario: WEB_SFA_MD_CUST_UI_017_DELIVERY_TAB
	...
	# Step 4
	When the user clicks on 'Generic Drop Down Trigger' with value 'Supplier Code 1'
	...
	And the user validates that 'Supplier Code 1' is read-only
	...
	| New customer    | Bill-to, Ship-to and POS | United States of America | US17    | CUST_UI_017  | Strada Palat | 44                    | EC86173  | 123      | Ship to and point of Sales | EC10359  | VAT Number       | Customer Code  | Name       | CODVAT       | Austria | Euro | IMMEDIATE INVOICE | SOCIETY | VIA SALES REP | s    | 60 DAYS FROM INVOICE DATE | VAT    | 1000.00   | 1000.00    | 1000.00    | 1000.00    | 0.00             |