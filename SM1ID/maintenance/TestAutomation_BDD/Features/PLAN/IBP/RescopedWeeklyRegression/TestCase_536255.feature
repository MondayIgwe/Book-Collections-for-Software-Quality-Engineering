Feature: TestCase_536255

@BDD_536255 @PLAN_Weekly @PLAN @Regression @PLAN_Regression
Scenario: WEB_TPM_IBP_SPLIT_004-AGGRRULE=MAX and SPLIT=EMPTY 
	...
	| CBP_2020       | SHELL_MEASURES | 1       | 1        | SEC_MEASURES_1 | [F_MEASURE3] | [F_MEASURE4] | EC94098_4 | M2    | GRID_FR_MEASURES_1 | 50    | 50     | M2,MEASUR4 | MEASUR4 | 102       | 103       | 132        |