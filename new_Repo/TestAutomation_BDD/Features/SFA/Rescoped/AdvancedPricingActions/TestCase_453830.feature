...
Scenario: TC_453830_WEB_SFA_SF_CNVACT_025_
	...
	When the user filters the column by column name 'Code', 'Like', '<Canvass1>'
	...
	Then the user validates that the 'Main Constraints Toolbar' with value 'leaf' is enabled
	When the user clicks on 'Main Constraints Toolbar' with value 'leaf'
	And the user clicks on 'Generic Drop Down Trigger' with value 'Object'
	And the user select value containing '<Object1>' from dropdown list 'Object'
