Feature: TestCase_544911

@BDD_544911 @PROMO_Regression @PromoActions
Scenario: WEB_TPM_SP_PROMODOCUMENT_WEEKLYSPLIT_NOT_SHOWN_IN_TEMPLATE_001
...
Examples:
	...
	| Level 5 | EC86162  | Template          | TPR in %  | d+1/m/y     | d+15/m/y  | Weekly Split In Template Test |