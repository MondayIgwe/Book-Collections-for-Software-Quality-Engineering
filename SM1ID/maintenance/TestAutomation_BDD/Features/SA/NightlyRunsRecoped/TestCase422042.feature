...
Scenario: WEB_SA_AGREEMENT_AGREEMENTS_001
	...
	# Step 5
	And the user validates that 'Start Date' text with value 'Agreement Validity' contains '01/01'

	# Step 6
	And the user validates that 'End Date' text with value 'Agreement Validity' contains '12/31'
	...
	And the user validates that 'Tag Field By Label Name' with value 'Customer Holder' contains text '<customer>'

	# Step 13
	And the user validates that the 'Popup Ok Button' with value 'New Agreement' is enabled

	# Step 14 - 15
	When the user selects validity period from: '03/02/y' to: '29/10/y' on the 'Agreement Validity Period Trigger' field
	...
	Then the user validates that 'Input By Label Name' with value 'Customer Holder' contains text '<customer>'
	And the user validates that 'Start Date' text with value 'Validity' contains '<startDate>'
	And the user validates that 'End Date' text with value 'Validity' contains '<endDate>'
