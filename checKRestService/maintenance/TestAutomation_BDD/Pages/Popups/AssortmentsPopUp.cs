...
namespace Kantar_BDD.Pages.Popups
{
    ...
    public class AssortmentsPopUp
    {
        ...
        public static readonly AbstractedBy CustomerNodeDropDown = AbstractedBy.Xpath("Assortment Customer Node Drop Down", "//div[@sm1-id = 'CODPARTY']//div[@class='sm1-triggers']//div[contains(@id,'sm1editableentityselector')][contains(@class,'sm1selecttrigger')]");
