...
Scenario: WEB_TPM_IBP_AGGREGATION_ROL_MEAS_NOTAGG_006-US425392-AC4-Example 1
	...
	When the user changes the filter on Filter Name: '<FLT_Rolmeas_Meas>' to Filter Value: '<Measure>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	...
	And the user changes the filter on Filter Name: '<FLT_Rolmeas_Month>' to Filter Value: '<Month>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	...
	And the user enters the Text: '<Value>' on the Aggrid Grid Table Name: '<GridName>' at Row: 'EC94101_4|07_5|MEAS2_ROL' and Column: '<Month>'
	...
	Then the user validates on the Aggrid Grid Table Name: '<GridName>' at Row: 'EC94101_4|07_5|MEAS2_ROL' and Column: '<Month>' and has the Text: '<Value>'
