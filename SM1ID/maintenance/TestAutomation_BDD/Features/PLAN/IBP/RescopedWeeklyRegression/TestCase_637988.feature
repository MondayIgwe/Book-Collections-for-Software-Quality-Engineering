...
Scenario: WEB_TPM_IBP_SPLIT_ROL_MEAS_NOTAGG_006-US425392-AC3-Example 2
	...
	And the user changes the Combo Label: '<FLT_Rolmeas_Month>' to Combo Label: '<Month1>,<Month2>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
