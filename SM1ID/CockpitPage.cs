...
namespace Kantar_BDD.Pages.Promo
{
    ...
    class CockpitPage
    {
        ...
        public static readonly AbstractedBy PromoDescriptionTextField = AbstractedBy.Xpath("Promo Description Text Field", GenericElementsPage.InputElementBySM1ID("PROMO_DESCRIPTION").ByToString);
