...
@BDD_534985 @SFA_Nightly @SFA_Weekly
Scenario: WEB_SFA_MD_CUST_UI_016_DELIVERY_TAB
	...
	#Step 2
	Then the user validates that the page with 'Top Tab' with value 'Main' is loaded
	...
	| New customer    | Bill-to, Ship-to and POS | United States of America | US18    | CUST_UI_016  | Strada Palat | 50       | Maximum Order Value: Minimum order value must be smaller than Maximum order value | 200      | 44                    |