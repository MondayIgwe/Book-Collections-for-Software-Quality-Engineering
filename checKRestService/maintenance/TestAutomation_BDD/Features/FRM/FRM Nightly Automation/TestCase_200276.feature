...
Scenario: FRM_REFDOC_DROPDOWNACTION_001
    ...
    When the user creates a Reference doc with Date 1: 'Today'  Date 2: 'Today' Textbox: 'Test' Combo: 'voice1' DatePicker: 'Today' Force Uppercase On Validation: '200276'
    ...
    When the user clicks on 'Dropdown Panel Checkbox' with value 'CARTONS'
