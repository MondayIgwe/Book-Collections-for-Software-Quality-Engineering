Feature: TestCase_684662
    
@BDD_TC684662 @PLAN_Nightly @PLAN @Regression @PLAN_Regression
Scenario: WEB_TPM_IBP_GRID_004 - Horizontal scrollbar functionality for non-aggregated grids 
    ...
    # Step 5 - Validate: The first columns of the grid (related to the description/code of the dimensions and measure labels)
    ...
    | SHELL_ROLMEAS | 41      | 10       | CBP_2020       | SC_ROLMEAS_NOTAGG | [CBP_PROD_3] | [MEAS]  | GRID_FR_ROLMEAS_NOTAGG |   142      |
