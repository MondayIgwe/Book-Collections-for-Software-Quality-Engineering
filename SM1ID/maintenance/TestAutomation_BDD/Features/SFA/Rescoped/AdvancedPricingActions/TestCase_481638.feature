...
@SFA_Nightly @BDD_481638 @SFA_Weekly
Scenario: WEB_SFA_SF_CNVACT_058_Can_Edit_a_Benefit_node_in_canvass_action
	...
	And the user clicks on 'Input By Partial Label Name' with value 'Amount'
	And the user enters the characters '15000.00' in field 'Input By Partial Label Name' with value 'Amount'
	...
	And the user filters the column by column name 'Code', Filter Type 'Like', Value 'AdvancedPricingActionCode'
