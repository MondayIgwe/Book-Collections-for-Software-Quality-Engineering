...
namespace Kantar_BDD.StepDefinitions
{
    ...
    public class FeatureStepDefinitions : SeleniumStepDefinition
    {
        ...
        public void GivenTheUserNavigateToThePage(string page)
        {
            ...
            Assert.That(Selenium.ValidateElementOnPage(NavigationMenu.HomeToolbarPageName(page)), "Failed to navigate to page");
        }
        ...
        {
            int counter = 0;
            while (!Selenium.ValidateElementDisplayed(UserProfile.HomeToolbarUserButton, 120) && counter < 180)
            {
                Thread.Sleep(1000);
                counter++;
            }
