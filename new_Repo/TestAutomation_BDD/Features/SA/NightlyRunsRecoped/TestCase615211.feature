...
Scenario: WEB_SA_AGREEMENT_AGREEMENT DOCUMENT_PAYMENT SCHEDULE_003
	...
	When the user creates a New Document '<CustomerLevel>' '<CustomerHolder>' '<AgreementCode>' ''
	...
	And the user populates the New Rebate Details '<Classification>' '<Reason>' '<TargetType>' '<PaymentMode>' '<CalculationBasis>' '<RebateDescription>'
	...
	And the user validates that popup with sm1 ID 'agreementPayment' and name 'Payment Schedule' column 'Next Installment' has '02/28/y' with row text 'RebateCode'
	And the user validates that popup with sm1 ID 'agreementPayment' and name 'Payment Schedule' column 'Final Installment' has '12/31/y' with row text 'RebateCode'
	...
	And the user validates that popup with sm1 ID 'LOGICALPOPUP' and name 'Payment Schedule' column 'Installment Type' has '<InstallmentType>' with row text '12/31/y'
	And the user validates that popup with sm1 ID 'LOGICALPOPUP' and name 'Payment Schedule' column 'Installment Type' has '<InstallmentType2>' with row text '11/30/y'
