...
namespace Kantar_BDD.StepDefinitions
{
    ...
    public class MultiGridStepDefinitions : SeleniumStepDefinition
    {
        ...
        public void ThenTheUserValidatesThatTheMultiGridHasTheValueInTheColumnInTheRowWhereTheColumnIs(string tableName, string textToValidate, string validationColumn, string rowReferenceColumn, string rowData)
        {
        ...
        public void ThenTheUserValidatesThatTheMultiGridHasTheCheckboxCellIsMarkedAsInTheColumnInTheRowWhereTheColumnIs(string tableName, string onOrOff, string validationColumn, string rowReferenceColumn, string rowData)
        {
            AbstractedBy columns = Selenium.GetAbstractedBy(tableName + " Column");
            AbstractedBy rowsLeft = Selenium.GetAbstractedBy(tableName + " Left Rows");
            AbstractedBy rowsRight = Selenium.GetAbstractedBy(tableName + " Right Rows");
