...
@BDD_437999 @PROMO_Nightly @PromoActions
Scenario: WEB_TPM_SP_PROMODOCUMENT_WEEKLYSPLIT_001
	...
	And the user populates the cockpit '<DESCRIPTION>' '<SELLINSTART>' '<SELLINEND>' '<SELLOUTSTARTDATE>' '<SELLOUTENDDATE>' '<MECHANICS>'
	...
	And the user adds a product 'Family' '<FAM>'
	...
	And user validates that all product 'Weight' for column 'W 1' are set to '<COLUMNVALUES>'
	...
	Then user validates that all product 'Weight' for column 'W 1' are set to '30.000'
	And user validates that all product 'Weight' for column 'W 2' are set to '70.000'
	...
	Then user validates that all product 'Weight' for column 'W 1' are set to '50.000'
	And user validates that all product 'Weight' for column 'W 2' are set to '50.000'
	...
	And the user filters the column by column name 'Code', 'Like', '<CUSTOMER2>'
	...
	And the user creates a Promo '<CUSTLEV>' '<CUSTOMER2>'
	And the user populates the cockpit '<DESCRIPTION2>' '<SELLINSTART>' '<SELLINEND>' '<SELLOUTSTARTDATE>' '<SELLOUTENDDATE>' '<MECHANICS>'
	And the user clicks on 'Side Panel Tab' with value 'Cockpit'
	And the user retrieves text from element 'Input By Label Name' with value 'Action Id' and saves it as 'ActionId1'
	And the user adds a product 'Family' '<FAM>'
	...
	And user validates that all product 'Weight' for column 'W 1' are set to '<DEFW1>'
	And user validates that all product 'Weight' for column 'W 2' are set to '<DEFW2>'
