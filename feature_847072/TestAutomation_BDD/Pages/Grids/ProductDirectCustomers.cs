...
namespace Kantar_BDD.Pages.Grids
{
    ...
    class ProductDirectCustomers
    {
        ...
        public static readonly AbstractedBy AllColumnNames = AbstractedBy.Xpath("All Columns", "//div[@role='tabpanel' and @aria-hidden='false']//div[@role='grid' and contains(@id,'sm1treegrid')]//div[@aria-hidden='false' and @role='columnheader']//div[@class='x-column-header-text']//span");
