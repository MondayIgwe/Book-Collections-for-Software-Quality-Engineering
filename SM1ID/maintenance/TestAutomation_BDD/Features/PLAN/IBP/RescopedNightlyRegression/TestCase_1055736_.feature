...
@RESCOPED_BDD_1055736 @PLAN_Nightly @PLAN @Regression @PLAN_Regression
Scenario: WEB_TPM_IBP_FILTERS_Propagation_006-CASE 6
	...
	When the user changes the Combo Label: '[FILTER_PLANTO]' to Combo Label: '<CustomerFilter1>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '[FILTER_GROUP1]' to Combo Label: '<CustomerFilter2>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
