...
namespace Kantar_BDD.Pages.Grids
{
    ...
    public class GridPopups
    {
        ...
        public static AbstractedBy FilterSM1ID(string popUpName, string columnSm1ID) => AbstractedBy.Xpath("", "//div[text()='" + popUpName + "']//ancestor::div[@sm1-id and @role='dialog']//div[@role='columnheader'][@sm1-id='"+ columnSm1ID + "']//div[contains(@class,'filter')]");
    }
}
