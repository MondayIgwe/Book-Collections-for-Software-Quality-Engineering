...
@SFA_Nightly @BDD_645612 @SFA_Weekly
Scenario: WEB_SFA_SF_BUDGET_039_BALANCE_ADJUSTMENT_POPUP_CONFIRMATION
	...
	When the user removes all items by column 'Budget Group Description' filter type: 'Like' filter value: '<BdgGroupDescription>'
	...
	And the user clicks and enters '<DefInitialValue>' into the 'Initial Value' column in the Owners Tab in row numbwr '1'
	And the user clicks and enters '<DefInitialValue2>' into the 'Initial Value' column in the Owners Tab in row numbwr '2'
	And the user clicks and enters '<DefInitialValue3>' into the 'Initial Value' column in the Owners Tab in row numbwr '3'
	...
	And the user filters the column by column name 'Description', Filter Type 'Like', Value '<BdgGroupDescription>'
