...
@BDD_428189 @PROMO_Nightly @PromoActions
Scenario: WEB_TPM_SP_PRODUCTGRID_MEASUREVALUES_EDIT_002
	...
	And the user populates the cockpit '<HOLDERDESCR>' '<SELLINSTARTDATE>' '<SELLINENDDATE>' '<SELLOUTSTARTDATE>' '<SELLOUTENDDATE>' '<MECH>'
	...
	And the user adds a product '<PRODUCTLEVEL>' '<PRODREF1>'
	And the user adds a product '<PRODUCTLEVEL>' '<PRODREF2>'
