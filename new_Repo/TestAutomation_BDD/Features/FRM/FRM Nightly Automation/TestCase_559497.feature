...
Scenario: WEB_FRM_LIST_GRID_001
    ...
    # Step 7
    And the user clicks on 'Card Section Add Button' with value 'Multi-Selection with toolbar'
    Then the user validates that the 'Popup' with value 'Add detail: ' is present

    # Step 8
    And the user enters 'TC559497' in field 'Input By Label Name' with value '[POPUP.v1]'
