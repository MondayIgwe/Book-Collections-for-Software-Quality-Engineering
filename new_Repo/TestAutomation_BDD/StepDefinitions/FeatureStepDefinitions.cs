...
namespace Kantar_BDD.StepDefinitions
{
    ...
    public class FeatureStepDefinitions : SeleniumStepDefinition
    {
        ...
        public void WhenTheUserSelectsValidityPeriodOnTheField(string startDate, string endDate, string elementName)
        {
            ...
            {
                count++;
                StepHelpers.SelectDatePeriod(elementName, startDate, endDate);
                Thread.Sleep(1000);
            }
        }
        ...
        {
            Assert.That(StepHelpers.UploadFile(fileName, logicalName, fieldLabel));
        }
        ...
        {
            double intValue1 = double.Parse(GetValue(value1), NumberStyles.AllowThousands | NumberStyles.AllowLeadingSign | NumberStyles.AllowDecimalPoint);
            double intValue2 = double.Parse(GetValue(value2), NumberStyles.AllowThousands | NumberStyles.AllowLeadingSign | NumberStyles.AllowDecimalPoint);
            double intExpectedValue = double.Parse(GetValue(expectedValue), NumberStyles.AllowThousands | NumberStyles.AllowLeadingSign | NumberStyles.AllowDecimalPoint);
