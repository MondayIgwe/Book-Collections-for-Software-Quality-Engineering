...
Scenario: WEB_TPM_IBP_STRING_006
	...
	When the user changes the Combo Label: '<Filter1>' to Combo Label: '<FilterValue>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	...
	And the user changes the Combo Label: '<Filter1>' to Combo Label: '<FilterValue>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
