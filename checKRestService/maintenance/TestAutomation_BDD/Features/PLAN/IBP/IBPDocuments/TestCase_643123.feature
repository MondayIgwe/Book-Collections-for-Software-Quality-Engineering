...
Scenario: WEB_TPM_IBP_APPLY_VALUE_ROL_MEAS_NOTAGG_009-US425392-AC6-Example 1
	...
	And the user right clicks on the Aggrid Grid table at Row: 'EC93849_4|07_5|MEAS2_ROL' and Column: '<Quarter>' and Selects: 'Apply value > New value'

	# Step 6 - Validate pop-up containing an editing field appears. The pop-up contains 2 buttons: OK and Cancel.
	Then the user validates that the 'Popup' with value 'Value' is displayed
	And the user validates that the 'Input By Label Name' with value 'Value' is displayed
