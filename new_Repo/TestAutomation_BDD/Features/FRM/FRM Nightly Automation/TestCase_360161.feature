...
Scenario: FRM_REFDOC_TAGACTION_001
    ...
    And 'Teal Button Label' is populated with 'LABEL'
    And 'Orange Button Label' is populated with 'LABEL'
    And 'Red Button Label' is populated with 'LABEL'
    And 'Green Button Label' is populated with 'LABEL'
