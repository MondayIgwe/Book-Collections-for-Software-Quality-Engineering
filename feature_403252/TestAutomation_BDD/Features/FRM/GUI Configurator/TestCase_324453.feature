Feature: TestCase_324453

When the ALLOW NULL Property = TRUE set for Text Box Field, then the Text Box field is mandatory
When the ALLOW NULL Property = FALSE set for Text Box Field, then the Text Box field is optional

Scenario: WEB_FRM_LOGICAL_FIELD_TEXT_BOX_ALLOW_NULL
	...
	And the user clicks on the 'D1 Field Settings Icon'
	...
	Then the user validates that the 'D1 Field Mandatory Icon' is displayed
    ...
    And the user validates that the 'D1 Field Mandatory Icon' is displayed
	...
	Then the user is on the 'Summary Tab' page
	Then 'Toolbar Error Message Field' is populated with 'D1: Mandatory field empty'

	#Step9
    When the user enters 'test automation is cool' in the 'D1 Field'
	...
	When the user clicks on the 'Configurator Button'
	Then the user validates that the 'GUI Configurator On' is displayed
	When the user clicks on the 'D1 Field Settings Icon'
	Then the 'Gui Configurator Popup' is visible
    When the user clicks on the 'Allow Null Open Icon'
	Then the 'Value Field' is visible
	When the user clicks on the 'Value Dropdown Icon'
	...
	Then the user validates that the 'Save Success Toast Message' is displayed
	When the user clicks on the 'Configurator Button'
	Then the user validates 'D1 Field Mandatory Icon' is not visible