...
Scenario: FRM_REFDOC_FIELDFILTERMAKER_002
    ...
    When the user creates a Reference doc 'Today' 'Today' 'Test223528' 'voice1' 'Today' 'Test224091'
    ...
    And the user adds a filter in the filter maker popup 'Division' 'Equal' 'E001'
