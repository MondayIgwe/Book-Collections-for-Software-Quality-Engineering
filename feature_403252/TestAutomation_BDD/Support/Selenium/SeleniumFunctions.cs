...
namespace Kantar_BDD.Support.Selenium
{
    public class SeleniumFunctions
    {
        ...
        public List<Type> GetPageClasses()
        {
            ...
            var types = allTypes.Where(t => t.Namespace != null && t.Namespace.Contains("Kantar_BDD.Pages")).ToList();
        ...
        public void EnterTextByKeys(AbstractedBy by, string text)
        {
            ...
            for (int i = 0; i < arrayText.Length; i++)
            {
                ...
                FindOne(by).SendKeys(arrayText[i].ToString());
                Thread.Sleep(100);
            }
