...
Scenario: Test_Script
    ...
    When the user populates the Advanced Picing Action Benefits Tab where Benefit Type: '<BenefitType>', Benefit: '<BenefitValue>', Benefit UM: '<BenefitUMValue>', Benefit Sub-Reason: '<BenefitSubReason>'
