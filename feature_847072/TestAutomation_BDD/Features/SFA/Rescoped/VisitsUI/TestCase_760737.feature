...
Scenario: WEB_SFA_SE_VISIT_015_SUMMARY_TAB_IN_CUSTOMER_VISIT_UI
	...
	When the user filters the column by column name 'Id Visit', Filter Type 'Like', Value '000000000000000001620640006245'
	And the user opens the grid item in row '1'

	Then the user validates that the 'Toolbar Page Name' with value 'E CENTER Schäfer - Neuss | NEUSS' is present
	And the user validates that 'Selected Bubble Option by Input Name' with value 'Customer' contains text 'E CENTER Schäfer - Neuss'
	...
	And the user filters the column by column name 'Id Visit', Filter Type 'Like', Value '000000000000000001620640819467'
	And the user opens the grid item in row '1'

	Then the user validates that the 'Toolbar Page Name' with value 'ENOTECA PROVINO | PIACENZA' is present
	And the user validates that 'Selected Bubble Option by Input Name' with value 'Customer' contains text 'ENOTECA PROVINO'
	And the user validates that 'Input By Label Name' with value 'User' has text 'SFA Automation 7'
	...
	When the user closes all pages without saving the work done where there is no pop up
	And the user filters the column by column name 'Id Visit', Filter Type 'Like', Value '000000000000000001620640939502'
	And the user opens the grid item in row '1'

	Then the user validates that the 'Toolbar Page Name' with value 'FAGJ SRL | VERONA' is present
	And the user validates that 'Selected Bubble Option by Input Name' with value 'Customer' contains text 'FAGJ SRL'
	And the user validates that 'Input By Label Name' with value 'User' has text 'SFA Automation 7'
	...
	When the user closes all pages without saving the work done where there is no pop up
	And the user filters the column by column name 'Id Visit', Filter Type 'Like', Value '000000000000000001620641485946'
	And the user opens the grid item in row '1'

	Then the user validates that the 'Toolbar Page Name' with value 'E CENTER Kaarst - Kaarst | KAARST' is present
	And the user validates that 'Selected Bubble Option by Input Name' with value 'Customer' contains text 'E CENTER Kaarst - Kaarst'
	And the user validates that 'Input By Label Name' with value 'User' has text 'SFA Automation 7'
