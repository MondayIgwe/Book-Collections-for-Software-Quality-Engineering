...
Scenario: WEB_SFA_SF_BUDGET_001_CREATE_DISCOUNTS_BUDGET
	...
	Then the user validates that the 'Input By Label Name' with value 'Code' is visible
	...
	And the user selects validity period 'd-1/m/y' '01/01/2100' on the 'Generic Drop Down Trigger' with value 'Validity period' without validation
	...
	When the user selects validity period 'd+1/m/y' '01/01/2100' on the 'Generic Drop Down Trigger' with value 'Validity period'
	And the user clicks on 'Popup Button' with value 'OK'
	Then the user validates that the 'Input By Label Name' with value 'Description' is visible
	...
	Then the user is on the '<BdgGroupCode> | <BdgGroupDescription>' page
	...
	Then the user is on the 'Budget Group' page
