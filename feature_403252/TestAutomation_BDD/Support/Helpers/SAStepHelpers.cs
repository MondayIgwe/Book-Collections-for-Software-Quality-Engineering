...
namespace Kantar_BDD.Support.Helpers
{
    public class SAStepHelpers
    {
        ...
        public void CreateABalance(string customerLevel, string customerCode, string BalanceYear = null, string Supplier = null)
        {
            ...
            if (string.IsNullOrEmpty(BalanceYear))
                StepHelpers.SelectsDropdownValueByFieldWithValue(BalanceYear, "Year");
