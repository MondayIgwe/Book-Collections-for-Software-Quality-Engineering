...
@RESCOPED_BDD_516823 @PLAN_Nightly @PLAN @Regression @PLAN_Regression
Scenario: WEB_TPM_IBP_STRING_004-Split when Aggrule=DISTINCTCOUNT
	...
	When the user changes the Combo Label: '[F_STRING2]' to Combo Label: '<CustomerFilters>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
