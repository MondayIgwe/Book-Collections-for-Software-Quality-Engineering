Feature: TestCase_463681

@BDD_463681 @PROMO_Regression @FundsAndRules
Scenario: WEB_TPM_SP_FRDOCUMENT_MOVEMENTS_008
	#1 PRECONDITION 1
	...
	And the user validates that the 'Popup Grid Rows' with value 'Create New Movement' is present
	...
	And the user clicks on element 'Popup Grid Row' with value 'Create New Movement' and value '2'
	...
	And the user validates that popup 'Create New Movement' column 'Fund value' has '2,300.0000' with row text 'FundsRulesCode1'
	...
	#Select a constraint and click "ADD"
...
Examples:
	...
	| 632 - Sales Fund | WEB_TPM_SP_FRDOCUMENT_MOVEMENTS_008#1 | WEB_TPM_SP_FRDOCUMENT_MOVEMENTS_008#2 | Level 2       | 2300   | 1300   | Confirm | Transfer Into | VALUE:     | REASON:     | 700           | TEST   |