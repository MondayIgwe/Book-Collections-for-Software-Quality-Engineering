...
namespace Kantar_BDD.Pages
{
    ...
    public class NavigationMenu
    {
        ...
        public static AbstractedBy SelectedPage(string page) => AbstractedBy.Xpath("Select Page", "(//div[@sm1-id='mainMenuGroupsContainer']//span[text()='" + page + "'])[position()=1]");
        public static AbstractedBy SelectedPage(string division, string page) => AbstractedBy.Xpath("Select Page", "(//div[@sm1-id='mainMenuGroupsContainer']//label[text()='"+division+"']//following::div//span[text()='"+page+"'])[position()=1]");
