    ...
    public class PromoStepHelpers
    {
        ...
        public void CreateAPromo(string customerHLevel, string customerCode, string confirmLevel = null, string refYear = null, string productSegment = null )
        {
            ...
            if (!String.IsNullOrEmpty(confirmLevel))
                StepHelpers.SelectsDropdownValueByFieldWithValue(confirmLevel, "Confirmation level", false);
        ...
        {
            Selenium.FluentWaitElementToBeNotPresentInDOM(Selenium.GetAbstractedBy("Loading Mask", new string[] { }), 300);
            Selenium.ClickUntilElementIsDisplayed(GenericElementsPage.AddButton, GenericElementsPage.GenericDropDownTrigger("Configuration ID"), 5);
            StepHelpers.SelectsDropdownValueByFieldWithValue(configurationID, "Configuration ID", false);
            ...
            StepHelpers.SelectsDropdownValueByFieldWithValue(CustomerLevel, "Customer level", false);
            int count = 0;
            ...
            {
                StepHelpers.SelectsDropdownValueByFieldWithValue(RateFundSource, "Rate Fund Source", false);
            }
        }
