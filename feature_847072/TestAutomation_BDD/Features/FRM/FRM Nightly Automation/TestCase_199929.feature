...
Scenario: FRM_REFDOC_TEXTBOX_002
    ...
    # Validation
    Then the user validates that 'Main Toolbar Error Message Field' is populated with 'TEXTBOX: Mandatory field empty'
    ...
    # Validation
    Then the user validates that 'Input By Label Name' with value 'D1' has text 'my first test'
    ...
    # Validation
    Then the user validates that 'Input By Label Name' with value 'D1' has text 'test validation'
    ...
    Then the user validates that the 'Input By Label Name' with value 'D1' has a number of characters less than '300' 
    ...
    And the user validates that the 'Trigger Clear Button' with value 'D1' is enabled
    ...
    Then the user validates that 'Input By Label Name' with value 'TEXTBOX' has text 'textbox'
