...
Scenario: WEB_TPM_SP_PRODSELECTOR_PROMOASSORTMENT_MANDATORY_AND_DISPLAY_001
	...
	When the user checks the 'Grid Row CheckBox' with value '<PRODUCTS>'
	And the user checks the 'Grid Row CheckBox' with value '<PRODUCTS2>'
	And the user checks the 'Grid Row CheckBox' with value '<PRODUCTS3>'
	And the user checks the 'Grid Row CheckBox' with value '<PRODUCTS4>'
	And the user checks the 'Grid Row CheckBox' with value '<PRODUCTS5>'
	And the user checks the 'Grid Row CheckBox' with value '<PRODUCTS6>'
	And the user checks the 'Grid Row CheckBox' with value '<PRODUCTS7>'
	...
	And the user clicks on 'Grid Row CheckBox' with value '<DISPLAY>'
	And the user clicks on 'Grid Row CheckBox' with value '<DISPLAY2>'
	And the user clicks on 'Grid Row CheckBox' with value '<DISPLAY3>'
	And the user clicks on 'Grid Row CheckBox' with value '<DISPLAY4>'
