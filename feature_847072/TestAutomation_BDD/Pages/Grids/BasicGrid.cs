...
namespace Kantar_BDD.Pages.Grids
{
    ...
    public class BasicGrid
    {
        ...
        public static AbstractedBy GridRowCheckbox(string uniqueRowText) => AbstractedBy.Xpath("Grid Row CheckBox", "(//*[text()='" + uniqueRowText + "']/ancestor::tr[position()=1]//*[@class='x-grid-cell-inner x-grid-checkcolumn-cell-inner' or @src])[1]");
        ...
        public static AbstractedBy JobsManagerButton = AbstractedBy.Xpath("Jobs Monitor Button", "//div[@sm1-id='homeToolbarJobsManagerBTN']");
