...
@BDD_846640 @PLAN_Weekly @PLAN @Regression @PLAN_Regression
Scenario: WEB_TPM_IBP_Multihierarchy_AggRules_002
	...
	When the user changes the Combo Label: '<FilterProd>' to Combo Label: '<Prod1>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	...
	When the user changes the Combo Label: '<FilterProd>' to Combo Label: '<Prod2>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
