...
@BDD_416948 @PROMO_Nightly @FundsAndRules
Scenario: WEB_TPM_SP_NAVIGATORS_CHECKS_001
	...
	And user validates that the columns for 'Basic Grid Column' do not start with '[' and end with ']'
	...
	When the user makes all coumns visible
	Then user validates that the columns for 'Basic Grid Column' do not start with '[' and end with ']'
	...
	And the user clicks on 'Side Panel Tab' with value 'Links'
	And the user clicks on 'Top Tab' with value 'Customer (Ship-To(s))'
	Then the user validates that the 'Alert Dialog Message Box' is not present
	When the user makes all coumns visible
	Then user validates that the columns for 'Basic Grid Column' do not start with '[' and end with ']'
	When the user clicks on 'Top Tab' with value 'Customer (promo holder)'
	Then the user validates that the 'Alert Dialog Message Box' is not present
	When the user makes all coumns visible
	Then user validates that the columns for 'Basic Grid Column' do not start with '[' and end with ']'
	When the user clicks on 'Top Tab' with value 'Child promo holders'
	Then the user validates that the 'Alert Dialog Message Box' is not present
	When the user makes all coumns visible
	Then user validates that the columns for 'Basic Grid Column' do not start with '[' and end with ']'
	And the user validates that the 'Basic Grid Column' with value '<CHILD_PROMO_HOLDERS>' is present
	When the user clicks on 'Top Tab' with value 'Matched Claims'
	Then the user validates that the 'Alert Dialog Message Box' is not present
	When the user makes all coumns visible
	Then user validates that the columns for 'Basic Grid Column' do not start with '[' and end with ']'
	When the user clicks on 'Top Tab' with value 'Matched Claims - Promotions'
	Then the user validates that the 'Alert Dialog Message Box' is not present
	When the user makes all coumns visible
	Then user validates that the columns for 'Basic Grid Column' do not start with '[' and end with ']'
	#5 Close the Promo
	...
	When the user navigates to the 'Default Week Split Driver' page
	And the user makes all coumns visible
	...
	When the user navigates to the 'Ship-to customers/Products' page
	And the user makes all coumns visible
	...
	Then 'Home Toolbar Docs' text with value 'Promo Plan' contains 'Customer'
	And 'Home Toolbar Docs' text with value 'Promo Plan' contains 'YearofReference'
	...
	And the user select value '<CONFIGURATION>' from dropdown list 'Configuration ID'
