...
namespace Kantar_BDD.Pages.Promo
{
    ...
    class ProductsPage
    {
        ...
        public static readonly AbstractedBy PromoConfirmWhatIfButton = AbstractedBy.Xpath("Promo Confirm WhatIf Button", "//span[text()='Confirm What-If']/ancestor::span[@data-ref='btnWrap']/following-sibling::div");
