Feature: TestCase_643907
    AC1 - The first column of the aggregated grid is frozen

@BDD_TC643907 @PLAN_Nightly @PLAN @Regression @PLAN_Regression
Scenario: WEB_TPM_IBP_GRID_001-US643099
    ...
    # Step 5 - Validate:The first column of the grid (related to the description/code of the dimensions)
...
Examples:
	...
	| SHELL_DEMO2_2 | 6       | 2        | CBP_2020       | [GUIGWPLANDOC.SEC_P&L_DEMO2_2] | [CBP_PROD_3] | [MEAS]  | GRID_FR_P&L_DEMO2_2 | 131        |
