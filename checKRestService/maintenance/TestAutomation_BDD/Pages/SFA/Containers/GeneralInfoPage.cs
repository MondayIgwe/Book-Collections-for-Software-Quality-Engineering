...
namespace Kantar_BDD.Pages.SFA.Containers
{
    ...
    public class GeneralInfoPage
    {
        ...
        public static AbstractedBy BudgetGroupValidityPeriod = AbstractedBy.Xpath("Budget Group Validity Period", "//div[@sm1-id='VALIDITYPERIOD']//div[contains(@id,'trigger-picker')]");
    }
}
