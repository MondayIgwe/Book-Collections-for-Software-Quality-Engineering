...
namespace Kantar_BDD.Features.PLAN.IBP.RescopedNightlyRegression
{
    ...
    [NUnit.Framework.DescriptionAttribute("TestCase_594464")]
    public partial class TestCase_594464Feature
    {
...
#line 1 "TestCase_594464.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/PLAN/IBP/RescopedNightlyRegression", "TestCase_594464", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("WEB_TPM_IBP_GRID_001-US582776 - AC1 - The first column of the aggregated grid is " +
            "frozen")]
        [NUnit.Framework.CategoryAttribute("BDD_594464")]
        [NUnit.Framework.CategoryAttribute("PLAN_Nightly")]
        [NUnit.Framework.CategoryAttribute("PLAN")]
        [NUnit.Framework.CategoryAttribute("Regression_")]
        [NUnit.Framework.TestCaseAttribute("CBP_2020", "SHELL_DEMO2_2", "6", "2", "[GUIGWPLANDOC.SEC_P&L_DEMO2_2]", "GRID_FR_P&L_DEMO2_2", "131", null)]
        public virtual void WEB_TPM_IBP_GRID_001_US582776_AC1_TheFirstColumnOfTheAggregatedGridIsFrozen(string docProcessYear, string docShellModel, string docWeek, string docMonth, string sectionName, string gridName, string documentID, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("WEB_TPM_IBP_GRID_001-US582776 - AC1 - The first column of the aggregated grid is " +
                    "frozen", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 4
...
#line hidden
#line 19
 testRunner.Then("the user validates that the \'Aggrid Column Header Name\' with value \'M1\' is displa" +
