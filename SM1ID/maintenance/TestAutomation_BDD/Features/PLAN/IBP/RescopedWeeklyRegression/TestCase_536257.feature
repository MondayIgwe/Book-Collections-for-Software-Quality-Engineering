Feature: TestCase_536257

@BDD_536257 @PLAN_Weekly @PLAN @Regression @PLAN_Regression
Scenario:WEB_TPM_IBP_SPLIT_006-AGGRRULE=AVG with a weight and SPLIT=EMPTY 
	...
	# Step 6 - The value of @AggCell (at the aggregate level) is @Value1
	...
	Then the user validates on the Aggrid Grid Table Name: '<GridName>' at Row: '<Customer>' and Column: '<Month>|<Measure>' and has the Text: '<Value1>'
	...
	Examples:
	| DocProcessYear | DocShellModel  | DocWeek | DocMonth | SectionName    | Filter1      | Filter2      | Customer  | Month | GridName           | Value | Value1 | Value2 | AggCell    | Measure | ProdCell1 | ProdCell2 | DocumentID |
	| CBP_2020       | SHELL_MEASURES | 1       | 1        | SEC_MEASURES_1 | [F_MEASURE3] | [F_MEASURE4] | EC94101_4 | M2    | GRID_FR_MEASURES_1 | 159   | 159    | 159    | M2,MEASUR6 | MEASUR2 | 100       | 103       | 132        |