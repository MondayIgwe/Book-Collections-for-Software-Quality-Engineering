...
@BDD_508646 @PLAN_Nightly @PLAN @Regression @PLAN_Regression
Scenario: WEB_TPM_IBP_FILTERS - Filter on shell-001
	...
	When the user changes the Combo Label: 'Customer Filter' to Combo Label: '<CustomerFilter>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '[FLT_MONTH]' to Combo Label: '<MonthFilters>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
