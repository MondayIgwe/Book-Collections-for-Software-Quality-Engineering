...
namespace Kantar_BDD.Pages.Promo
{
    ...
    class ProfitAndLossPage
    {
        ...
        public static AbstractedBy ProfitLossRefreshButtonByField(string Field) => AbstractedBy.Xpath("Profit And Loss Refresh Button", "//span[text()='"+ Field + "']/ancestor::div[contains(@class,'x-panel SM1_LogicalPL')]//a[@sm1-id='ACTION_FETCH']");
