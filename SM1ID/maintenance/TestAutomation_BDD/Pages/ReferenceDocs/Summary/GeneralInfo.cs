...
namespace Kantar_BDD.Pages.ReferenceDocs.FieldExamples
{
    ...
    class GeneralInfo
    {
        ...
        public static readonly AbstractedBy CurrentStatusTextbox = AbstractedBy.Xpath("Current Status Textbox", GenericElementsPage.InputElementBySM1ID("WFSTATUS").ByToString);
        public static readonly AbstractedBy CurrentStatusTextboxStatusTrigger = AbstractedBy.Xpath("Current Status Textbox Status Trigger", GenericElementsPage.TextBoxStatusTriggerBySM1ID("WFSTATUS").ByToString);
