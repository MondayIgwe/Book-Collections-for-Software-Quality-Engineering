...
namespace Kantar_BDD.Features.SFA.SalesExecution.Claims
{
    ...
    [NUnit.Framework.DescriptionAttribute("TestCase_317049")]
    public partial class TestCase_317049Feature
    {
...
#line 1 "TestCase_317049.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/SFA/SalesExecution/Claims", "TestCase_317049", "\tCreates a new claim with the specified data and saves it,\r\n\tThe new claim is the" +
        ...
        [NUnit.Framework.DescriptionAttribute("Test Case : 317049")]
        ...
        public virtual void TestCase317049(string documentNumber, string level, string customer, string amount, string vATCode, string amount2, string totalAmount, string vATAmount, string grossAmount, string amountColumnSM1_Id, string vatAmountColumnSM1_Id, string grossAmountColumnSM1_Id, string netAmountColumnSM1_Id, string columnName, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Test Case : 317049", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
...
#line hidden
#line 23
 testRunner.And("the user clicks on the \'New Claim Ok Button\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 25
...
#line hidden
#line 32
 testRunner.When("the user clicks on the \'Summary Tab Button\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 34
 testRunner.Then("the user retrieves the Document ID", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 36
...
#line hidden
#line 43
 testRunner.Then("the new claim is present in the navigator", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 46
 testRunner.When("the user opens the claim in edit mode", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 48
 testRunner.And("the user is on the \'Matchings Tab\' page", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 50
 testRunner.When(string.Format("the user adds an invoice row \'{0}\' and \'{1}\'", vATCode, amount2), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 53
