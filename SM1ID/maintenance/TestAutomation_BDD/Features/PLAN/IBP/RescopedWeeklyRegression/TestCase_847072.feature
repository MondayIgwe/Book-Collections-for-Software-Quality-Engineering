...
@BDD_847072 @PLAN_Weekly @PLAN @Regression @PLAN_Regression
Scenario: WEB_TPM_IBP_Multihierarchy_AggRules_003
	...
	And the user changes the Combo Label: '<FILTERPROD>' to Combo Label: '<PROD1>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<FILTERPROD>' to Combo Label: '<PROD2>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
