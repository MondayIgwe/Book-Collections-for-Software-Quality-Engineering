...
Scenario: MD_ASSO_W_R_R80V1_0004
	...
	When the user creates a new assortment of Type: '<AssortmentType>', Customer: '<CustomerCode>', Start: '<BeforeDate2>', End: '<AfterDate2>', Description: '<AssortmentDescription2>', Status: '<Status2>', Save: 'yes'
	Then the user closes all pages without saving the work done where there is no pop up
	
	When the user creates a new assortment of Type: '<AssortmentType>', Customer: '<CustomerCode>', Start: '<BeforeDate3>', End: '<AfterDate3>', Description: '<AssortmentDescription3>', Status: '<Status3>', Save: 'yes'
	Then the user closes all pages without saving the work done where there is no pop up
	
	When the user creates a new assortment Type: '<AssortmentType>', Customer: '<CustomerCode>', Start: '<BeforeDate3>', End: '<AfterDate3>'
	Then the user closes all pages without saving the work done

	When the user creates a new assortment Type: '<AssortmentType>', Customer: '<CustomerCode>', Start: '<BeforeDate4>', End: '<AfterDate4>'
	Then the user closes all pages without saving the work done

	When the user creates a new assortment Type: '<AssortmentType>', Customer: '<CustomerCode>', Start: '<BeforeDate1>', End: '<AfterDate1>'
	...
	When the user selects validity period '<BeforeDate5>' '<AfterDate5>' on the 'New Assortment Validity Period' field
