...
Scenario: WEB_TPM_IBP_ROLMEAS_MATRIX_002
	...
	When the user changes the filter on Filter Name: '<FilterName>' to Filter Value: '<FirstValue>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	
	# Step 5 - In @GridName, set @Value for @Customer, @Product, @Meas1, @Year
	And the user enters the Text: '<Value>' on the Aggrid Grid Table Name: '<GridName>' at Row: 'EC86195_4|08_5|BASELINE' and Column: 'M10'
	And the user enters the Text: '<Value>' on the Aggrid Grid Table Name: '<GridName>' at Row: 'EC86195_4|08_5|BASELINE' and Column: '2020'
	
	# Step 6 - 1. The value for: @Customer, @Product, @Meas1, @Year is @Value;
	Then the user validates on the Aggrid Grid Table Name: '<GridName>' at Row: 'EC86195_4|08_5|BASELINE' and Column: 'M10' and has the Text: '<Value>'
	And the user validates on the Aggrid Grid Table Name: '<GridName>' at Row: 'EC86195_4|08_5|BASELINE' and Column: '2020' and has the Text: '<Value>'
