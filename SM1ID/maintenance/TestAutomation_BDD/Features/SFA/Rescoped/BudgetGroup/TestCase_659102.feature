...
@SFA_Nightly @BDD_659102 @SFA_Weekly
Scenario: WEB_SFA_SF_BUDGET_044
	...
	And the user adds a new User Division where Division: 'AUTOMATION', Group: 'MOB_DEFAULT - SFA Mobile Group', Connection type: '4 - Touch'
	...
	And the user filters the column by column name 'Code', Filter Type 'Like', Value '<User>'
	And the user clicks on 'Grid CheckBox Containing' with value '<User>'
	And the user closes the page and saves the work done

	When the user navigates to the 'Users' page
	And the user filters the column by column name 'User Code', Filter Type 'Like', Value '<User>'
	...
	And the user navigates to the 'Budget Group' page
	...
	Then the user validates that the page with 'Side Panel Tab' with value 'General Info' is loaded
	And the user validates that the 'Side Panel Tab' with value 'General Info' is visible
	...
	When the user filters the column by column name 'Code', Filter Type 'Like', Value '<User>'
	...
	And the user validates that the 'Budget Group Owners Tab Checkboxes' is visible

	When the user clicks on 'Budget Group Owners Tab Checkbox' with value '1'
