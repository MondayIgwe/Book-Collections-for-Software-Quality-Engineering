...
Scenario: TC_1049832_WEB_SFA_MD_CUST_UI_018_1_POS_TAB_SHIPTO_TAB
	...
	And the user filters the pop up menu: '<Title>' by column name 'Customer Code', 'Like', retieved value
	...
	Then 'Toolbar Grid Record Count' is populated with '0/7'
