...
Scenario: TC_464843_WEB_SFA_SF_CNVACT_032
	...
	# Step 2
	When the user filters the column by column name 'Code', 'Like', '<Canvass32>'
	...
	# Step 15
	And the user select value containing '1 - Free fixed item' from dropdown list 'Benefit type'
	# Step 16
	And the user clicks on 'Generic Drop Down Trigger' with value 'Product'
	And the user filters the column by column name 'Product', 'Like', '004'
