...
Scenario: FRM_REFDOC_DROPDOWNFIELD_005
    ...
    And the user clicks on the 'Multi Select Textbox Select Trigger'
    ...
    # Expected result - 
    Then the user validates that the element 'Multi Select Textbox' has text 'CARTONS | CUBIC METERS'

    # Step 3 - 
    When the user clicks on the 'Multi Select Textbox Select Trigger'
    ...
    # Expected result - 
    Then the user validates that the element 'Multi Select Textbox' has text 'BOTTLES | CARTONS | CUBIC METERS | KILOGRAMS'
    ...
    # Step 9 - 
    When the user clicks on the 'Single Select Textbox Select Trigger'
