...
Scenario: WEB_TPM_IBP_APPLYVALUE_AGG_003 - Apply new value for a portion of cells in an aggregated grid
	...
	When the user changes the Combo Label: 'Customer Filter' to Combo Label: '<CustomerFilters>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
