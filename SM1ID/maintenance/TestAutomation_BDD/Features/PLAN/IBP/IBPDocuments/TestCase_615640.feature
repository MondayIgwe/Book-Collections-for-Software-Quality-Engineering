...
Scenario: WEB_TPM_IBP_FORMULA_001-SOURCE Case1
	...
	And the user changes the Combo Label: '<Filter2>' to Combo Label: '<Measure1>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<Filter2>' to Combo Label: '<Measure2>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<Filter2>' to Combo Label: '<Measure3>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
