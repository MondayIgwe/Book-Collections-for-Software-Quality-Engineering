...
@SFA_Nightly @BDD_529521 @SFA_Weekly
Scenario: WEB_SFA_SF_CNVACT_086_Validation_on_Copy_canvass_action_Copy_error_message_Copy_ok_message_and_Copy_Actions_from_different_books
	...
	When the user filters the column by column name 'Code', Filter Type 'Like', Value 'WEB_SFA_SF_CNVACT_086'
	And the user filters the column by column name 'Description', Filter Type 'Not Like', Value 'Copy of'
