...
@BDD_433363 @PROMO_Nightly @FundsAndRules @FundsAndRulesNightly
Scenario: WEB_TPM_SP_PROMODOCUMENT_FUNDS_ASSOCIATION_001
	...
	When the user checks the 'Grid Row CheckBox' with value '#FundsRulesCode1#(1)-<FR1DESCRIPTION>'
	...
	#10 Select F&R_02
	And the user checks the 'Grid Row CheckBox' with value '#FundsRulesCode2#(1)-<FR2DESCRIPTION>'
