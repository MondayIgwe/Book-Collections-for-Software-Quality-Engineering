...
@BDD_533020 @SFA_Nightly @SFA_Weekly
Scenario: TC_533020_WEB_SFA_SF_PRICELIST_010_
	...
	And the user selects validity period from: '<ModifiedEndDate>' to: '<EndDate>' on the 'Generic Drop Down Trigger' element with value 'Validity Period'
