...
#line 60
 testRunner.And("the user validates that popup with sm1 ID \'agreementPayment\' and name \'Payment Sc" +
                        "hedule\' column \'Next Installment\' has \'28/02/y\' with row text \'RebateCode\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 61
 testRunner.And("the user validates that popup with sm1 ID \'agreementPayment\' and name \'Payment Sc" +
                        "hedule\' column \'Final Installment\' has \'31/12/y\' with row text \'RebateCode\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 65
...
#line 75
 testRunner.And(string.Format("the user validates that popup with sm1 ID \'LOGICALPOPUP\' and name \'Payment Schedu" +
                            "le\' column \'Installment Type\' has \'{0}\' with row text \'31/12/y\'", installmentType), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 76
 testRunner.And(string.Format("the user validates that popup with sm1 ID \'LOGICALPOPUP\' and name \'Payment Schedu" +
                            "le\' column \'Installment Type\' has \'{0}\' with row text \'30/11/y\'", installmentType2), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 79
