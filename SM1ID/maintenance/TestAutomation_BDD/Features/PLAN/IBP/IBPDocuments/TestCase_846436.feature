...
Scenario: WEB_TPM_IBP_Multihierarchy_Readonlyformula_001
	...
	When the user changes the Combo Label: '<Filter>' to Combo Label: '<Meas>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<Filter2>' to Combo Label: '<Product>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
