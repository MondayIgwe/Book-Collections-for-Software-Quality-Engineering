...
namespace Kantar_BDD.Pages.Grids
{
    ...
    public class BasicGrid
    {
        ...
        public static AbstractedBy CellCheckbox(string rows, string row, string col) => AbstractedBy.Xpath("",
            rows + "[" + row + "]//tbody//tr//td[" + col + "]//div//img");
        public static AbstractedBy ClickCell(string rows, string row, string col) => AbstractedBy.Xpath("", 
            rows + "[" + row + "]//tbody//tr//td[" + col + "]//div");
        public static AbstractedBy EnterTextCell(string rows, string row, string col) => AbstractedBy.Xpath("", 
