...
Scenario: FRM_REFDOC_CONFIGURABLEOBJECT_001
    ...
    When the user creates a Reference doc 'Today' 'Today' 'Test244625' 'voice1' 'Today' 'Test244625'
    ...
    Then 'Configurable Object Reference Field' is populated with 'SM1.LogicalAboutPopup'
    ...
    And 'Alert Dialog Message Box' is populated with 'Configurator is disabled on this component'
