...
@BDD_457489 @FundsAndRules @FundsAndRulesNightly @TestCaseInvalid
Scenario: WEB_TPM_SP_FRDOCUMENT_REMOVECONSTRAINTS_003
	...
	And the user clicks on 'Grid CheckBox' with value '<VALIDITYEND1>' until 'Remove Button' is enabled
