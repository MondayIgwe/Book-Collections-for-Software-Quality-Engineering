...
Scenario: WEB_SA_AGREEMENT_AGREEMENTS_004
    ...
    And the user validates that the 'Custom Field' with value 'Like' is not present
	When the user clicks on '<Customer>' text on the grid
	...
	When the user selects active scenario '<Classification>' from dropdown list 'Classification'
	When the user selects active scenario '<Reason>' from dropdown list 'Reason'
	And the user enters '<TargetType>' in field 'Input By Label Name' with value 'Target Type'
	And the user clicks on 'Input By Label Name' with value 'Classification'
	When the user selects active scenario '<CalculationBasis>' from dropdown list 'Calculation Basis'
	When the user selects active scenario '<PaymentMode>' from dropdown list 'Payment Mode'
    ...
    And the user clicks on 'Popup Ok Button' with value 'New Rebate:'
    And the user filters the column by column name 'Rebate Header ID', 'Not Like', 'RebateCode'
    ...
    And the user clicks on 'Popup Ok Button' with value 'New Promotion'
	...
	When the user checks that grid row is selected and clicks Mass copy '<AgreementCode>'
	...
	# step 10
	When the user clicks on 'Element by SM1Id' with value 'TAB_REBATES'
	When the user clicks on 'Grid All Checkbox Index' with value '2'
	When the user clicks on 'Grid All Checkbox Index' with value '2'
