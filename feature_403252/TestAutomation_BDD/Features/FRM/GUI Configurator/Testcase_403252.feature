...
Scenario: WEB_FRM_DIVISION_CONFIGURATOR_001
	...
	Then the user validates that the 'Empty Configuration Option' is visible
	When the user clicks on the 'Empty Configuration Option'	
	...
	Then the user validates that the 'Generic Drop Down Value' with value '<DivisionComboList>' is present
