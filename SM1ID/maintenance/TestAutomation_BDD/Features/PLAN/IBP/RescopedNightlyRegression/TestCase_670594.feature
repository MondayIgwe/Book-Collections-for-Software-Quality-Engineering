Feature: TestCase_670594
    
@BDD_TC670594 @PLAN_Weekly @PLAN @Regression @PLAN_Regression
Scenario: WEB_TPM_IBP_FORMULA_011-IF Case3-Bug 663212
    ...
    # Step 15 - Open filter @Filter2 on customer at section level
