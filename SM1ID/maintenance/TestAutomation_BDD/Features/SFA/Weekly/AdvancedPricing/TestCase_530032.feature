...
Scenario: 530032_WEB_SFA_SF_CNVACT_094_AND operator is added automatically in the Main/Valorization/Benefit tree
	...
	Then the user validates that the 'Side Panel Tab' with value 'Customers' is displayed
	When the user clicks on 'Top Tab' with value 'Customer Simulation'
	...
	Then the user validates that the 'Popup' with value 'Benefit group' is displayed
	...
	Then the user validates that the user is on the 'Advanced Pricing Actions' page
