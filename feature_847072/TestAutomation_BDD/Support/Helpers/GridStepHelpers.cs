...
namespace Kantar_BDD.Support.Helpers
{
    public class GridStepHelpers
    {
        ...
        /// <summary>
        /// Refreshes the Nav Grid page until a data chnage occures or refrshes 10 times
        /// </summary>
        public void RefreshPageUntilDataIsAddedToTheGrid()
        {
            ...
            {
                Selenium.Click(GenericElementsPage.RefreshButton);
                Thread.Sleep(500);
