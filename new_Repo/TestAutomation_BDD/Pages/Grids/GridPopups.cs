...
namespace Kantar_BDD.Pages.Grids
{
    ...
    public class GridPopups
    {
        ...
        public static AbstractedBy SelectRow(string popup, string rowNumber) => AbstractedBy.Xpath("Generic Row",
            "(//div[text() = '" + popup + "']//ancestor::div[@role='dialog']//table//tbody//tr)[" + rowNumber + "]");
        ...
        public static AbstractedBy Filter(string popUpName, string columnName) => AbstractedBy.Xpath("", "//div[text()='" + popUpName + "']//ancestor::div//span[text()='" + columnName + "']//ancestor::div[@role='columnheader']//div[contains(@class,'filter')]");
        ...
        public static AbstractedBy PopUpGridCheckBoxByName(string Popup, string value) => AbstractedBy.Xpath("PopUp Grid CheckBox By Name", "//div[text()='" + Popup + "']//ancestor::div[@sm1-id]//div[text()='" + value + "']/ancestor::tr//*[@class='x-grid-cell-inner x-grid-checkcolumn-cell-inner' or (@src and not(contains(@src,'disabled')))]");
        public static AbstractedBy PopUpGridCheckBox(string value) => AbstractedBy.Xpath("PopUp Grid CheckBox", "//div[@sm1-id and @role='dialog']//div[text()='"+ value + "']/ancestor::tr//*[@class='x-grid-cell-inner x-grid-checkcolumn-cell-inner' or (@src and not(contains(@src,'disabled')))]");
        ...
        public static AbstractedBy SelectRowCheckbox(string popUpName, string index) => AbstractedBy.Xpath("Select Row Checkbox",
