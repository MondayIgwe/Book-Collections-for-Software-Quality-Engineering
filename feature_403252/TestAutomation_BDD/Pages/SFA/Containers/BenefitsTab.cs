...
namespace Kantar_BDD.Pages.SFA.Containers
{
    ...
    {
        public static AbstractedBy Node(string mainNode) => AbstractedBy.Xpath("", "//span[contains(@class,'tree-node-text')][text() = '" + mainNode + "']");
        public static AbstractedBy Node(string parentNode, string childNode) => AbstractedBy.Xpath("",
            "//span[contains(@class,'tree-node-text')][text() = '" + parentNode + "']//ancestor::table[contains(@id,'treeview')]//following-sibling::table[contains(@id,'treeview')]//span[contains(text(),'" + childNode + "')]");
        public static AbstractedBy Node(string grandParentNode, string parentNode, string childNode) => AbstractedBy.Xpath("",
            "//span[contains(@class,'tree-node-text')][text() = '" + grandParentNode + "']//ancestor::table[contains(@id,'treeview')]//following-sibling::table[contains(@id,'treeview')]//span[contains(text(),'" + parentNode + "')]//ancestor::table[contains(@id,'treeview')]//following-sibling::table[contains(@id,'treeview')]//span[contains(text(),'" + childNode + "')]");
