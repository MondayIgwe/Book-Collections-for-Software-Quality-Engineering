...
Scenario: WEB_SFA_SE_VISIT_007_VISIT_INFO_TAB_FOR_CUSTOMERS_AND_POS_BDD
	...
	When the user filters the column by column name 'Id Visit', 'Like', '<FilterValue1>'
	...
	When the user clicks on 'Top Tab' with value 'Customer Master'
	Then the user validates that the 'Div Text in Grid' with value 'EC47378' is displayed

	When the user clicks on 'Top Tab' with value 'Survey activities'
	Then the user validates that the 'Div Text in Grid' with value 'Attachments' is displayed
	And the user validates that the 'Div Text in Grid' with value 'Customer visit' is displayed
	And the user validates that the 'Div Text in Grid' with value 'Contact' is displayed
	And the user validates that the 'Div Text in Grid' with value 'Price Check' is displayed
	And the user validates that the 'Div Text in Grid' with value 'Store check' is displayed

	When the user closes all pages without saving the work done where there is no pop up
	Then the user is on the 'Visits' page
	
	When the user filters the column by column name 'Id Visit', 'Like', '<FilterValue2>'
	And the user opens the grid item in row '1'
	And the user clicks on 'Side Panel Tab' with value 'Visit info'
	...
	When the user clicks on 'Top Tab' with value 'Customer Master'
	Then the user validates that the 'Div Text in Grid' with value '40003041' is displayed
