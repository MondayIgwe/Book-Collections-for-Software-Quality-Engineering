...
namespace Kantar_BDD.Features.SA.NightlyRunsRecoped
{
    ...
    [NUnit.Framework.DescriptionAttribute("TestCase204115")]
    public partial class TestCase204115Feature
    {
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/SA/NightlyRunsRecoped", "TestCase204115", "\tWEB_SA_AGREEMENT_REBATES_007 - Run \"Accruals update\"", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("WEB_SA_AGREEMENT_REBATES_007")]
        [NUnit.Framework.CategoryAttribute("TTC_Nightly")]
        [NUnit.Framework.CategoryAttribute("TTC")]
        [NUnit.Framework.CategoryAttribute("BDD_20411")]
        [NUnit.Framework.TestCaseAttribute("EC86206", "Level 3", "Supply", "Year End Bonuses", "Unconditional", "500.00", "Net sales revenue", "Invoice payable", "Monthly", "Confirm", "Accruals", "Completed with Success", "Calculation Results", "Calculation Session", null)]
        public virtual void WEB_SA_AGREEMENT_REBATES_007(string customer, string level, string classification, string reason, string targettype, string fixedAmount, string dataSource, string paymentMode, string paymentFrequency, string status, string calculationSessionType, string calculationStatus, string calcResultsPopup, string calcSessNavigator, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("WEB_SA_AGREEMENT_REBATES_007", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 5
...
#line hidden
#line 30
 testRunner.And("the user clicks on \'Menu Item Text\' with value \'Accruals update\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 33
...
#line hidden
#line 37
 testRunner.And(string.Format("the user retrieves text from column \'Session Code\' with unique row text \'{0}\' and" +
                            " saves it as \'sessionCode\'", calculationSessionType), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 38
 testRunner.Then(string.Format("the user validates that column \'Document typology\' has \'{0}\' with row text \'{1}\'", calculationSessionType, calculationStatus), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 41
 testRunner.When(string.Format("the user retrieves text from column \'Month\' with unique row text \'{0}\' and saves " +
                            "it as \'monthValue\'", calculationSessionType), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 42
 testRunner.When(string.Format("the user retrieves text from column \'Calculation year\' with unique row text \'{0}\'" +
                            " and saves it as \'yearValue\'", calculationSessionType), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 43
...
#line hidden
#line 57
 testRunner.When(string.Format("the user clicks on column \'{0}\' with row text \'RebateCode\'", calcResultsPopup), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 58
 testRunner.Then(string.Format("the user validates that column \'Fixed Amount\' has \'{0}\' with row text \'{1}\'", fixedAmount, customer), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 61
 testRunner.When("the user clicks on the \'Close Tab\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 62
    testRunner.Then(string.Format("the user validates that the \'Text\' with value \'{0}\' is displayed", calculationStatus), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 65
 testRunner.When("the user clicks on the \'Close Tab\'", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
