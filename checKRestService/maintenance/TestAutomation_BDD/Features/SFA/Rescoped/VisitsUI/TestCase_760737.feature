...
Scenario: WEB_SFA_SE_VISIT_015_SUMMARY_TAB_IN_CUSTOMER_VISIT_UI
	...
	And the user validates that 'Tag Field By Label Name' with value 'Customer' contains text 'E CENTER Schäfer - Neuss'
	...
	And the user validates that 'Tag Field By Label Name' with value 'Customer' contains text 'ENOTECA PROVINO'
	And the user validates that 'Input By Label Name' with value 'User' has text 'SFA Automation 7'
	...
	And the user validates that 'Tag Field By Label Name' with value 'Customer' contains text 'FAGJ SRL'
	And the user validates that 'Input By Label Name' with value 'User' has text 'SFA Automation 7'
	...
	And the user validates that 'Tag Field By Label Name' with value 'Customer' contains text 'E CENTER Kaarst - Kaarst'
	And the user validates that 'Input By Label Name' with value 'User' has text 'SFA Automation 7'
