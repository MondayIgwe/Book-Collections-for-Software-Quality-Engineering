...
Scenario: TPM_SP_W_SMOKE_R80V1_0013 - Mass Copy
	...
	And the user checks the 'Grid Row CheckBox' with value 'ActionId1'
	And the user checks the 'Grid Row CheckBox' with value 'ActionId2'
	And the user checks the 'Grid Row CheckBox' with value 'ActionId3'
	And the user checks the 'Grid Row CheckBox' with value 'ActionId4'
	#Click on "Mass Copy"
