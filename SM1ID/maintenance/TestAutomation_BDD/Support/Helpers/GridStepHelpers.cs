...
namespace Kantar_BDD.Support.Helpers
{
    public class GridStepHelpers
    {
        ...
        /// <returns>column element that is doing to be interacted with</returns>
        ...
        /// </summary>
        /// <param name="ColumnHeaders">AbstractedBy locator for column headings</param>
        /// <param name="columnName">Column heading/name</param>
        ...
        /// <param name="dataInCellRow">Data in cell</param>
        /// <param name="offset">Off set value</param>
        /// <param name="strict"></param>
        /// <returns>The int row position</returns>
        ...
        /// </summary>
        /// <param name="cell">AbstractedBy locator for the cell</param>
        /// <returns>string of chkvalue value in a grid, if the checkboxes are enabled, true or false, if disabled true_disabled or false_disabled</returns>
        ...
        /// <param name="offset">Number to add or subtract to align column headers to the correct table columns</param>
        /// <param name="rowOffset">Number to add or subtract to align to the correct table rows</param>
        ...
        /// <summary>
        /// Returns the AbstractedBy of the row that corresponds to the correct Multi-grid row group (left or right)
        /// </summary>
        /// <param name="columnHeadersBy">Locator of the column headers for the grid</param>
        /// <param name="leftRow">Locator of all rows in the Left side of the table</param>
        /// <param name="rightRow">Locator of all rows in the right side of the table</param>
        /// <param name="columnNameInMultiGridTable">Name of the column to interact with</param>
        /// <returns>AbstractedBy Locator of the row to interact with</returns>
        ...
        /// <returns>Abstracted By locator of a cell specified by the arguments</returns>
        public AbstractedBy GetGridAbstractedByByColumnNameAndRowText(string columnName, string rowText, string gridName = null, string smOneId = "", bool strictValidation = false)
        {
            ...
            if (gridName == null)
            {
                columnsLocator = BasicGrid.Columns;
            ...
            if (gridName == null)
            {
                abstractedBy = BasicGrid.DivByColumnAndRow(rowIndex.ToString(), columnIndex.ToString());
            }
            else if (gridName == "")
            {
        ...
        public AbstractedBy GetGridAbstractedByByColumnNameAndRowNumber(string columnName, string rowNumber, string gridName = null, string smOneId = "", bool strictValidation = false)
        {
            ...
            if (gridName == null)
            {
                abstractedBy = BasicGrid.DivByColumnAndRow(rowNumber.ToString(), columnIndex.ToString());
            }
            else if (gridName == "")
            {
        ...
        /// <summary>
        /// Gets the checkbox status for a multigrid table
        /// </summary>
        /// <param name="columnHeadersBy">Column headings xpath</param>
        ...
        /// <param name="offset">The number added to the index in order to get the correct cell in the grid (grid dependent)</param>
        /// <returns>True if checkbox is selected and False if the checkbox is not selected</returns>
        ...
        /// </summary>
        /// <param name="columnHeadersBy">AbstractedBy locator for the headings</param>
        /// <param name="columnName">Column name to interact with</param>
        /// <param name="rowsBy">AbstractedBy locator for the rows</param>
        ...
        /// <summary>
        /// Retrieves the index of an element containing a specific text from a list of elements
        /// </summary>
        /// <param name="by">AbstractedBy locator for the list of elements</param>
        /// <param name="value">Text to validate</param>
        /// <param name="strict">If strictValidation is false, the validation checks whether a column row contains a text. If strictValidation is true, the validation checks whether a column row text equals the text</param>
        /// <returns>Indexof the required ekement</returns>
        ...
        /// <summary>
        /// Validates that a column has a specific text
        /// </summary>
        ...
        /// <returns>True if the text us in the column/False if the value is not in the column</returns>
        public bool ValidateTextValueIsInColumn(string columnName, string textToValidate, string gridName = null)
        {
            ...
            foreach (var row in rowElements)
            {
                ...
                try
                {
                    ...
                    if (gridName == null)
                    {
                        valueIsPresent = Selenium.GetText(BasicGrid.DivByColumnAndRow(rowIndex.ToString(), columnIndex.ToString())).Equals(textToValidate);
                        if (valueIsPresent)
                        {
                            break;
                        }
        ...
        /// <summary>
        /// Validates if the column is sorted by the correct orderOfSort
        /// </summary>
        /// <param name="columnName">Column name of the column to sort</param>
        /// <param name="orderOfSort">Order to sort the column into - Ascending or Descending</param>
        /// <returns>True if the column is sortef in the expected order/False if not</returns>
        ...
        /// <summary>
        /// Sorts a column by the orderOfSort
        /// </summary>
        /// <param name="columnName">Column name of the column to sort</param>
        /// <param name="orderOfSort">Order to sort the column into</param>
        /// <param name="timeout">Maximum timeout value</param>
        /// <returns>True is the column is sorted in the desired column order else false</returns>
        ...
        /// <summary>
        /// Enters text into multi-grid table cell
        /// </summary>
        ...
        /// <param name="textToEnter">Text/value to enter</param>
        /// <param name="offsetColumn">Column name to move/offset from</param>
        ...
        /// </summary>
        /// <param name="checkbox">AbstractedBy locator for the checkbox</param>
        ...
        /// <summary>
        /// Retrieves column text by columnName and rowNumber - possible duplicate of ExtractTextFromTable
        /// </summary>
        ...
        /// <returns>AbstractedBy locator of the desired cell</returns>
        ...
        /// <summary>
        /// Gets the AbstractedBy of a cell in the specified column and row number
        /// </summary>
        /// <param name="referenceColumn">Column name with unique values</param>
        /// <param name="columnName">Column name to get AbstractedBy from</param>
        ...
        /// <summary>
        /// Refreshes the UI Grid page until a data change occurs or refreshes 10 times
        /// </summary>
        public void RefreshPageUntilDataIsAddedToTheUIGrid()
        {
            string referenceText = Selenium.GetText(GridToolbarToDelete.NumberOfRows);
            string compareText = Selenium.GetText(GridToolbarToDelete.NumberOfRows);
            int counter = 0;
            ...
            while (referenceText.Equals(compareText) && counter < 10)
            {
                ...
                Thread.Sleep(500);
                compareText = Selenium.GetText(GridToolbarToDelete.NumberOfRows);
                counter++;
            }
        }
        ...
        /// </summary>
        /// <param name="columnName">Name of the column to validate</param>
        ...
        /// <summary>
        /// Gets table cell by column name and unique row text
        /// </summary>
        /// <param name="columnName">Column name to get abstracted by from</param>
        /// <param name="rowText">Unique text from any column</param>
        /// <param name="strictValidation">If strictValidation is false, the validation checks whether a column row contains a text. If strictValidation is true, the validation checks whether a column row text equals the text</param>
        ...
        public AbstractedBy GetCellAbstractedBy(string columnName, string rowText,bool strictValidation = false)
        {
            ...
            AbstractedBy abstractedBy = BasicGrid.DivByColumnAndRow(rowIndex.ToString(), columnIndex.ToString());
