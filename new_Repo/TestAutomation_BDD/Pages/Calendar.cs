...
namespace Kantar_BDD.Pages
{
    ...
    class Calendar
    {
        ...
        public static readonly AbstractedBy CalendarMonthPickerOkButton = AbstractedBy.Xpath("", "//div[contains(@class,'sm1-daterangepicker-popup' ) and not(contains(@style,'display: none'))]//div[contains(@class,'x-panel-body')]//span[contains(text(),'OK')]");
        ...
        public static AbstractedBy StartDateField(string fieldName) => AbstractedBy.Xpath("Start Date", "//span[text()='" + fieldName + ":']//following::div//input[@class='sm1-startDate']");
        public static AbstractedBy EndDateField(string fieldName) => AbstractedBy.Xpath("End Date", "//span[text()='" + fieldName + ":']//following::div//input[@class='sm1-endDate']");
    }
}
