...
Scenario: FRM_REFDOC_NAVIGATORGRID_001
    ...
    Then the user validates that the 'Division' column is not sorted
    Then the user validates that the 'Date 1' column is not sorted
    Then the user validates that the 'Progressive' column is not sorted
