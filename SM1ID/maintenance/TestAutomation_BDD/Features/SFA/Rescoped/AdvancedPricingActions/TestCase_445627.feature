...
@SFA_Nightly @BDD_445627 @SFA_Weekly
Scenario: WEB_SFA_SF_CNVACT_020_Can_add_Threshold_and_Benefit_Group_in_Benefit_Bracket_sub_tab_Valorization_type_Replica
	...
	When the user filters the column by column name 'Code', Filter Type 'Like', Value 'WEB_SFA_SF_CNVACT_020'
	...
	Then the user validates that element: 'Button Link Data Qtip' with value: 'Threshold' and attribute: 'data-qtip' is in state: 'Add threshold'

	When the user moves the focus to 'Button Link' with value 'Benefit Group'
	Then the user validates that element: 'Button Link Data Qtip' with value: 'Benefit Group' and attribute: 'data-qtip' is in state: 'Add benefit group'
