...
Scenario: WEB_TPM_SP_FRDOCUMENT_REMOVECONSTRAINTS_003
	...
	When the user unchecks the 'Grid CheckBox' with value '<VALIDITYEND1>'
	And the user unchecks the 'Grid CheckBox' with value '<VALIDITYEND2>'
	And the user clicks on 'Grid CheckBox' with value '<VALIDITYEND2>' until 'Remove Button' is enabled
	And the user clicks on the 'Remove Button'
