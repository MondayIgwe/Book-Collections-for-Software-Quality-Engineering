...
Scenario: WEB_TPM_SP_PROMOPLANDOCUMENT_SCENARIOREASSIGN_001
	...
	And the user populates the cockpit with description: '<PROMODESC1>' sellInStart: '<SELLINSTART>' sellInEnd: '<SELLINEND>' sellOutStart: '<SELLOUTSTART>' sellOutEnd: '<SELLOUTEND>' mechanics: '<MECHANICS>'
