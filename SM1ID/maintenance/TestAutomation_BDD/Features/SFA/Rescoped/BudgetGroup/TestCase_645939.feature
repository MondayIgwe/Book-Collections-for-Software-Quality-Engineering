...
@BDD_645939 @SFA_Nightly @SFA_Weekly
Scenario: WEB_SFA_SF_BUDGET_036_TRANSFER_POPUP_CONFIRMATION
	...
	And the user clicks on 'Text in Grid' with value 'Discounts'
	And the user clicks on the 'Links Button'

	And the user clicks on 'Text' with value 'Budget Detail'
	And the user clicks on 'Text in Grid Containing' with value 'User0'
	...
	And the user filters the pop up menu with title: 'Columns Settings' by column name 'Caption' Filter condition: 'Like' Field Value: 'Budget group code'
	...
	And the user filters the pop up menu with title: 'Budget detail' by column name 'Budget group code' field name: 'Like' and retieved value
	And the user clicks on 'Popup Select Row Checkbox' with value one 'Budget detail' and value two '1'

	And the user clicks on 'Popup Select Row Checkbox' with value one 'Budget detail' and value two '2'
	And the user clicks on 'Popup Ok Button' with value 'Budget detail'

	Then the user validates that the 'Text in Grid' with value 'User1' is displayed
	And the user validates that the 'Text in Grid' with value 'User2' is displayed
	...
	When the user clicks on 'Text in Grid Containing' with value 'User0'
	And the user clicks on the 'Links Button'

	And the user clicks on 'Text' with value 'Budget Movements'

	Then the user validates that the 'Basic Multigrid' multigrid has the value 'Manual movement' in the 'Operation Type' column in the row number '1'
	...
	And the user clicks on 'Text in Grid Containing' with value 'User1'
	And the user clicks on 'Text in Grid Containing' with value 'User2'
