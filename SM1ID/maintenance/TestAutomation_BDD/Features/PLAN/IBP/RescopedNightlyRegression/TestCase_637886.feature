...
Scenario: WEB_TPM_IBP_FILTERS_ROL_MEAS_NOTAGG_002
	...
	And the user changes the Combo Label: '<Filter1>' to Combo Label: '<Product>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<Filter2>' to Combo Label: '<Meas>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
