...
Scenario: WEB_FRM_WIZARD_POPUP_VALIDATION
    ...
    When the user creates a Reference doc with Date 1: 'Today'  Date 2: 'Today' Textbox: 'Test' Combo: 'voice1' DatePicker: 'Today' Force Uppercase On Validation: '560508'
    ...
    And the user validates that the element 'Wizard Step' with value '1' is selected
    And the user validates that 'Popup Title' is populated with 'Wizard Popup Example: WP 1 1/3'
    ...
    And the user validates that 'Wizard Popup Example Popup Error Field' is populated with 'Text Box: Mandatory field empty'
    ...
    And the user validates that 'Popup Title' is populated with 'Wizard Popup Example: WP 2 2/3'
    ...
    And the user validates that 'Popup Title' is populated with 'Wizard Popup Example: WP 3 3/3'
    And the user validates that the 'Popup Button' with value 'Back' is enabled
    And the user validates that the 'Popup Button' with value 'Cancel' is enabled
    And the user validates that the 'Popup Button' with value 'Next' is disabled
    And the user validates that the 'Popup Button' with value 'Confirm' is disabled
    ...
    And the user clicks on 'Popup Button' with value 'Confirm'
