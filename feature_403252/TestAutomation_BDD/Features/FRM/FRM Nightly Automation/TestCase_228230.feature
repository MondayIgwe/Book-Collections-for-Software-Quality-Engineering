...
Scenario: FRM_REFDOC_CHECKBOXCOLUMN_001
    ...
    When the user creates a Reference doc 'Today' 'Today' 'Test' 'voice1' 'Today' 'Test228230'
    ...
    And the user adds an attachment 'TC228230 Url' 'Url' 'https://en.wikipedia.org/wiki/Selenium_(software)#/media/File:Seleniumlogo.png' 'false'

    # Step 5 - Add an URL attachment with primary flag as TRUE
    And the user adds an attachment 'TC228230 Image' 'File' 'img1.jpg' 'true'
