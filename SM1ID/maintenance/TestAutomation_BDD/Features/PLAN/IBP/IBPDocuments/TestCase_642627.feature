...
@BDD_642627 @PLAN_Nightly @PLAN @Regression @PLAN_Regression
Scenario: WEB_TPM_IBP_AGGREGATION_ROL_MEAS_NOTAGG_006-US425392-AC4-Example 1
	...
	When the user changes the Combo Label: '<FLT_Rolmeas_Meas>' to Combo Label: '<Measure>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<FLT_Rolmeas_Meas>' to Combo Label: '<Measure1>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<FLT_Rolmeas_Customer>' to Combo Label: '<Customer>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<FLT_Rolmeas_Month>' to Combo Label: '<Month1>,<Month>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	And the user changes the Combo Label: '<FLT_Rolmeas_Prod>' to Combo Label: '<ProdCell>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
	...
	And the user enters the Text: '<Value>' on the Aggrid Grid Table Name: '<GridName>' at Row: '<Customer>|<ProdCell>|<Measure1>' and Column: '<Month>'
	And the user enters the Text: '<Value>' on the Aggrid Grid Table Name: '<GridName>' at Row: '<Customer>|<ProdCell>|<Measure1>' and Column: '<Quarter>'
	And the user enters the Text: '<Value>' on the Aggrid Grid Table Name: '<GridName>' at Row: '<Customer>|<ProdCell>|<Measure1>' and Column: '<Year>'
	...
	Then the user validates on the Aggrid Grid Table Name: '<GridName>' at Row: '<Customer>|<ProdCell>|<Measure1>' and Column: '<Month>' and has the Text: '<Value>'
	And the user validates on the Aggrid Grid Table Name: '<GridName>' at Row: '<Customer>|<ProdCell>|<Measure1>' and Column: '<Quarter>' and has the Text: '<Value>'
	And the user validates on the Aggrid Grid Table Name: '<GridName>' at Row: '<Customer>|<ProdCell>|<Measure1>' and Column: '<Year>' and has the Text: '<Value>'
