...
{
    [PageName("Advanced Pricing Actions - Main Constraints Tab")]
    public class MainConstraintsTab
    {
        ...
        public static AbstractedBy NotesListTab = AbstractedBy.Xpath("Notes Top Tab", GenericElementsPage.VisibleElementBySM1ID("TABDESAPPLTREE").ByToString);
        public static AbstractedBy NotesTextArea = AbstractedBy.Xpath("Notes Text Area", GenericElementsPage.InputElementBySM1ID("DESAPPLTREE").ByToString);
