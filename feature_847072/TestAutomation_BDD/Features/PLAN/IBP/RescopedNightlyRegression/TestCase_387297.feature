...
@RESCOPED_387297_BDD_ @PLAN_Nightly @PLAN @Regression
Scenario: WEB_TPM_IBP_FILTERS_Propagation_007-CASE 7
	...
	And the user changes the filter on Filter Name: '<Filter2>' to Filter Value: '<Customer1>' and filters with User Code: 'User Code', Filter Type: 'Like' in the IBP Shell Tab
