Feature: TestCase_536258

@BDD_536258 @PLAN_Weekly @PLAN @Regression @PLAN_Regression
Scenario: WEB_TPM_IBP_SPLIT_008-AGGRRULE=MIN and SPLIT=MEAS 
	...
	# The value of the the cell @Measure, @ProdCell2, @Customer, @Month is empty
	...
	| CBP_2020       | SHELL_MEASURES | 1       | 1        | SEC_MEASURES_2 | [F_MEASURE3] | [F_MEASURE4] | EC94721_4 | M2    | GRID_FR_MEASURES_2 | 30    | 0      | M2,MEASUR8 | MEASUR28| 100       | 103       | 101        |