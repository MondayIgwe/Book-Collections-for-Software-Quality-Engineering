...
namespace Kantar_BDD.Pages.Grids
{
    ...
    public class ProductGrid
    {
        ...
        public static readonly AbstractedBy AllColumnNames = AbstractedBy.Xpath("All Product Grid Columns", "//div[@role='grid' and contains(@id,'sm1treegrid')]//div[@aria-hidden='false' and @role='columnheader']//div[@class='x-column-header-text']//span");
