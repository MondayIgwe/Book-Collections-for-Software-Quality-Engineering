...
namespace Kantar_BDD.Pages.Grids
{
    ...
    class FundsGrid
    {
        ...
        public static AbstractedBy ColumnsByUniqueTableColumn = AbstractedBy.Xpath("All Funds Grid Columns", "//*[text()='Committed Balance']/ancestor::div[@sm1-id='GridContainer']//div[contains(@class,'x-column-header ')][@aria-hidden='false']");
