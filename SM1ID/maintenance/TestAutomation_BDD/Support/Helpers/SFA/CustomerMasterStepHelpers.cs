...
{
    public class CustomerMasterStepHelpers : CommonStepHelpers
    {
        ...
        public void AddNewCustomerMaster(string customerType, string nation = null, string vatCode = null, string billTo = null, string shipTo = null, int customerPosition = 0)
        {
            ...
            if(billTo != null)
            {
                Selenium.Click(GenericElementsPage.SecondaryGenericDropDownTrigger("Bill-to"));
            ...
            if (shipTo != null)
            {
                Selenium.Click(GenericElementsPage.SecondaryGenericDropDownTrigger("Ship-to"));
                Selenium.ValidateElementDisplayed(CustomerMasterGrid.SelectRow(1.ToString()), 30);
            ...
            {
                List<IWebElement> elementList = Selenium.Find(GenericElementsPage.SecondaryGenericDropDownTrigger("Customer"));
