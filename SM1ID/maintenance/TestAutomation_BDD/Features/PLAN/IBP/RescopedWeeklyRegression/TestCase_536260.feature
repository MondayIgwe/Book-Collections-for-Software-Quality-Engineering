Feature: TestCase_536260

@BDD_536260 @PLAN_Weekly @PLAN @Regression @PLAN_Regression
Scenario: WEB_TPM_IBP_SPLIT_010-AGGRULE=AVG with no weight and SPLITRULE=MEAS
	...
	| CBP_2020       | SHELL_MEASURES | 1       | 1        | SEC_MEASURES_2 | [F_MEASURE3] | [F_MEASURE4] | EC86195_4 | M3    | GRID_FR_MEASURES_2 | 1,000 | 1,000  | M2,MEASUR10 | MEASUR10 | 102       | 103       |