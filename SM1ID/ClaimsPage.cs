...
namespace Kantar_BDD.Pages
{
    ...
    class ClaimsPage
    {
        public static AbstractedBy DocumentTypeTextbox = AbstractedBy.Xpath("Document Type Textbox", GenericElementsPage.InputElementBySM1ID("cmbDocType").ByToString);
        public static AbstractedBy CustomerSelectorOpenTriggerIcon = AbstractedBy.Xpath("Customer Selector Open Trigger Icon", GenericElementsPage.TextBoxOpenTriggerBySM1ID("customerSelector").ByToString);
        public static AbstractedBy AmountTextbox = AbstractedBy.Xpath("Amount Textbox", GenericElementsPage.InputElementBySM1ID("numNetAmount").ByToString);
        public static AbstractedBy DocumentIDTextbox = AbstractedBy.Xpath("Document ID Textbox", GenericElementsPage.InputElementBySM1ID("DOCUMENTID").ByToString);
        public static AbstractedBy MatchToTextbox = AbstractedBy.Xpath("Match To Textbox", GenericElementsPage.InputElementBySM1ID("cmbMatchToOption").ByToString);
        public static AbstractedBy AssignButton = AbstractedBy.Xpath("Assign Button", GenericElementsPage.ButtonBySM1ID("btnAssign").ByToString);
