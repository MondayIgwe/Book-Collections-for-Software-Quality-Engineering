...
namespace Kantar_BDD.StepDefinitions
{
    ...
    public class SFAStepDefinition : SeleniumStepDefinition
    {
        ...
        public void WhenTheUserCreatesANewAssortment(string Type, string CustomerNode, string StartDate, string EndDate)
        {
        ...
        public void WhenTheUserCreatesANewAssortment(string Type, string CustomerNode, string StartDate, string EndDate, string Description, string Status, string YesOrNo)
        {
            Selenium.Click(GenericElementsPage.AddButton, 30);
            AssortmentStepHelpers.PopulateNewAssortmentPopUp(Type, CustomerNode, StartDate, EndDate);
        ...
        {
            Selenium.ValidateEnabledAndDisplayed(CustomersPage.AssortmentCustomerCustomerCode(elementName, rowNumber));
        }
