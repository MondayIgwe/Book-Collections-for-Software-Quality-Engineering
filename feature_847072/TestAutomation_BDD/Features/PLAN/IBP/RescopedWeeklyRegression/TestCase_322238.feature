...
@BDD_322238 @PLAN_Weekly @PLAN @Regression
Scenario: WEB_TPM_IBP_WORKFLOW-CONFIRMED to CANCELLED
	...
	When the user clicks on the 'Toolbar Close Button' if it exists
	...
	# Step 8 - Validate grid is visible before closing the browser
