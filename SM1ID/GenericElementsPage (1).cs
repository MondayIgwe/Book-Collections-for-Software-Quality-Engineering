...
namespace Kantar_BDD.Pages
{
    ...
    public class GenericElementsPage
    {
        ...
        public static readonly AbstractedBy OkButton = AbstractedBy.Xpath("OK Button", "//*[@sm1-id='SM1OkButton' or @sm1-id='messageboxbuttonok']");
        ...
        public static AbstractedBy TextBoxComboTriggerBySM1ID(string sm1Id) => AbstractedBy.Xpath("Textbox Combo Trigger by SM1Id", "//*[@sm1-id='" + sm1Id + "']//div[@class='sm1-triggers']//*[contains(@id,'sm1combo') or contains(@id,'sm1dropdon') or contains(@id,'trigger-picker')]");
        ...
        public static AbstractedBy CalculateButton = AbstractedBy.Xpath("Calculate Button", ButtonBySM1ID("ACTION_CALCULATE").ByToString);
    }
}
