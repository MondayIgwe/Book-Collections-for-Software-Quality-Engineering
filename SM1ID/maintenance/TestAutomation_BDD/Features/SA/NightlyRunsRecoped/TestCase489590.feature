...
Scenario: WEB_SA_AGREEMENT_AGREEMENT DOCUMENT_002
	...
	And the user validates that 'Input By Label Name' text with value 'Holder' contains '<CustomerHolder>'
	...
	And the user validates that 'Start Date' text with value 'Rebate validity' contains '<startDate>'
	...
	Then the user validates that 'Input By Label Name' with value 'Agreement ID' has text 'AgreementID'
	...
	# Step 15
    When the user clicks on 'Side Panel Tab' with value 'Payment Schedule'
	Then the user validates that popup with sm1 ID 'cardSettlements' and name 'Payment Schedule' column 'Date' has '<Date>' with row text '0.00'
	...
	And the user validates that 'Input By Label Name' with value 'Payment mode' has text '<PaymentMode>'
	And the user validates that 'Input By Label Name' with value 'Payment Frequency' has text '<PaymentFrequency>'
	And the user validates that 'Start Date' text with value 'Rebate validity' contains '01/01/2022'
	And the user validates that 'End Date' text with value 'Rebate validity' contains '<Date>'
	And the user validates that 'Start Date' text with value 'CALCULATION BASIS VALIDITY' contains '01/01/2022'
	And the user validates that 'End Date' text with value 'CALCULATION BASIS VALIDITY' contains '<Date>'
