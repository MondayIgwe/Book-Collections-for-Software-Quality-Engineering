...
namespace Kantar_BDD.StepDefinitions
{
    ...
    public class SFAAdvancedPricingActionsStepDefinition : SeleniumStepDefinition
    {
        ...
        public void WhenTheUserAddsANewAdvancedProcingActionWithAdvancedPricingBookApplicationTypeValorizationType(string advancedPricingBook, string applicationType, string valorizationType)
        {
            ...
            SaveValue("AdvancedPricingActionCode", AdvancedPricingActionsStepHelpers.AdvancedPricingActionsCode);
        }
        ...
        [When(@"the user populates the Advanced Pricing Action Benefits Tab where Benefit Type: '([^']*)', Benefit: '([^']*)', Benefit UM: '([^']*)', Benefit Sub-Reason: '([^']*)'")]
        public void WhenTheUserPopulatesTheAdvancedPicingActionBenefitsTabWhereBenefitTypeBenefitBenefitUMBenefitSub_Reason(string benefitType, string benefitValue, string benefitUMValue, string benefitSubReason)
        {
            AdvancedPricingActionsStepHelpers.AdvancedPricingBooksPopulateBenefitsPopUp(benefitType, benefitValue, benefitUMValue, benefitSubReason);
        }

        [When(@"the user populates the Advanced Pricing Action Benefits Tab where Benefit Type: '([^']*)', Benefit: '([^']*)', Benefit Sub-Reason: '([^']*)'")]
        public void WhenTheUserPopulatesTheAdvancedPicingActionBenefitsTabWhereBenefitTypeBenefitBenefitSub_Reason(string benefitType, string benefitValue, string benefitSubReason)
        {
            AdvancedPricingActionsStepHelpers.AdvancedPricingBooksPopulateBenefitsPopUp(benefitType, benefitValue, null, benefitSubReason);
        }
