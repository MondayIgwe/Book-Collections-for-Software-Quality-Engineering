...
Scenario: WEB_TPM_IBP_Multihierarchy_ClosedPeriod_001
	...
	And the user enters the Text: '<Value>' on the Aggrid Grid Table Name: '<GridName>' at Row: 'ORDER_DISC|SPW_009' and Column: 'EC87135_1|WM2'
	
	# Step 6 - The value for @AggCell is @Value
	Then the user validates on the Aggrid Grid Table Name: '<GridName>' at Row: 'ORDER_DISC|SPW_009' and Column: 'EC87135_1|WM2' and has the Text: '<Value>'
