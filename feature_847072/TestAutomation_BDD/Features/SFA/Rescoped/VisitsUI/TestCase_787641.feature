...
Scenario: WEB_SFA_SE_VISIT_005_MEASURES_SHOWN_IN_PRODUCT_ACTIVITY
	...
	When the user filters the column by column name 'Id Visit', Filter Type 'Like', Value '<FilterValue>'
	...
	Then the user validates that the user is on the 'Main Information Tab' page
