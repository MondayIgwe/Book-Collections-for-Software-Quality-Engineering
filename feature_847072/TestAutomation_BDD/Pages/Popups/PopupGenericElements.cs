...
namespace Kantar_BDD.Pages.Popups
{
    ...
    public class PopupGenericElements
    {
        ...
        public static readonly AbstractedBy GeneralPopupCancelButton = AbstractedBy.Xpath("General Popup Cancel Button", "//div[@role='dialog']//span[text()='Cancel']/ancestor::span[@role='button']");
        ...
        public static AbstractedBy GenericRefreshButtinPopUp(string popUpName) => AbstractedBy.Xpath("Generic Pop Up Refresh Button", "//div[text()='" + popUpName + "']//ancestor::div[contains(@class, 'sm1-popup')][not(contains(@class, 'sm1-popup-header-draggable'))]//a[(@sm1-id='ACTION_FETCH' or @sm1-id='ACTION_refresh') and @aria-hidden='false']");
        public static AbstractedBy PopupRemoveButton(string popupName) => AbstractedBy.Xpath("Popup Remove Button", "//div[contains(text(),'" + popupName + "')]/ancestor::div[@role='dialog']//span[@sm1-id='RemoveButton']");
        public static AbstractedBy PopupSaveButton(string popupName) => AbstractedBy.Xpath("Popup Save Button", "//div[contains(text(),'" + popupName + "')]/ancestor::div[@role='dialog']//*[@sm1-id='ACTION_save']");
