...
Scenario: TC_535562_WEB_SFA_MD_CUST_UI_018_POS_TAB
	...
	And the user filter the pop up menu: 'Columns Settings' by column name 'Caption', 'Like', '<Attribute>'
	...
	Then the user scrolls to the '<Attribute>' column in the '<Title>' pop-up table

	When the user filters the pop up menu: '<Title>' by column name '<Attribute>' for the checkbox state: '<Val>'
	...
	Then 'Toolbar Grid Record Count' is populated with '0/4'
