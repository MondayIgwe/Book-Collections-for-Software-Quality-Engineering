...
#line 37
 testRunner.And(string.Format("the user retrieves text from column \'Session Code\' with unique row text \'{0}\' and" +
                            " saves it as \'sessionCode\'", calculationStatus), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 38
 testRunner.Then(string.Format("the user validates that column \'Document typology\' contains \'{0}\' with row text \'" +
                            "{1}\'", calculationSessionType, calculationStatus), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 41
 testRunner.When(string.Format("the user retrieves text from column \'Month\' with unique row text \'{0}\' and saves " +
                            "it as \'monthValue\'", calculationStatus), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 42
 testRunner.When(string.Format("the user retrieves text from column \'Calculation year\' with unique row text \'{0}\'" +
                            " and saves it as \'yearValue\'", calculationStatus), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 43
